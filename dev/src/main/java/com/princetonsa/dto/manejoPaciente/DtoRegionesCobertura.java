...
public class DtoRegionesCobertura implements Serializable {

	/**
	 *  
	 */
   private static Logger logger = Logger.getLogger(DtoRegionesCobertura.class);
	/**
	 * 	
	 */
