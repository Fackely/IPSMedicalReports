...
public interface  GeneracionModificacionAjustesFacturasVariasDao
{
	/**
	...
	public  HashMap consultaFacturasVarias (Connection connection,HashMap criterios);
	 ...
	 /**
	  * Metodo encargado de identificar en que tablas buscar dependiendo de lo
	  * criterios de busqueda que le son enviados.
	  * @param connection
	  * @param criterios
	  * @return
	  */
