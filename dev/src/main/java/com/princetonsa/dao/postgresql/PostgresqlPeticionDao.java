 ...
 */
public class PostgresqlPeticionDao implements PeticionDao {
	...
	public HashMap cargarEncabezadoPeticion(Connection con, int nroPeticion, HashMap filtros) 
	{
		...
		String consulta =  " SELECT pqx.codigo as consecutivo, to_char(pqx.fecha_peticion, 'DD/MM/YYYY') as fecha_peticion," +
						   ...
						   "        list(ppq.pedido||'') As pedido, pqx.obs_materiales_especiales AS observMaterEspe, " +
						   "		pqx.urgente AS urgente," +
	...
	public int[] insertar( Connection con, 
									...
									boolean esContinuarTransaccion, boolean esModificar)
	{
		return SqlBasePeticionDao.insertar(con, mapaPeticionEncabezado, mapaPeticionServicios, mapaPeticionProfesionales, mapaPeticionMateriales, codigoPersona, idIngreso, usuario, esContinuarTransaccion, esModificar);
	}
