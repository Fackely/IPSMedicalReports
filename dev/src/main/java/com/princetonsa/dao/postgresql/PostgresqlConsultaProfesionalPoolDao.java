/*
 * @(#)PostgresqlConsultaProfesionalPoolDao.java
 *
...
/**
 * Interfaz para el acceder a la fuente de datos de la consulta de
...
public class PostgresqlConsultaProfesionalPoolDao implements ConsultaProfesionalPoolDao
{
	/**
