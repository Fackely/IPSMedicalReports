...
public class PostgresqlAntecedentesOftalmologicosDao implements AntecedentesOftalmologicosDao {
	...
	public Collection consultarTiposEnferOftalPersonales(Connection con, int codigoInstitucion, int paciente)
       ...
       * @param codAuxPaciente : para saber si tenia previamente informacion de antecedentes  
       * @return
       */
       ...
       * @return
       ...
       {
       	String secuencia="nextval('seq_otro_enfer_oftal') as codigo"; 
      	return SqlBaseAntecedentesOftalmologicosDao.insertarOtraEnferOftal(con, otroEnferOftal, secuencia, "");
       }
       ...
       {
         	String secuencia="nextval('seq_otro_enfer_oftal') as codigo";
         	String secuencia2="nextval('seq_ant_oftal_fam_det_otro') as codigo";
        	return SqlBaseAntecedentesOftalmologicosDao.insertarOtraEnferOftalFam(con, secuencia, secuencia2, nombre, paciente, "");
       }
	 ...
	 */
		...
		{
	     	String secuencia="nextval('seq_ant_oftal_perso_quirur') as codigo"; 
	   	  	return SqlBaseAntecedentesOftalmologicosDao.insertarEnferOftalPersoQuirur(con,secuencia, tipoProc,paciente, proce, fecha, causa, act, "");
		}  	
		...
		{
			String secuencia="nextval('seq_ant_oftal_fam_detalle') as codigo";
	   	  	return SqlBaseAntecedentesOftalmologicosDao.insertarEnferOftalFamDetalle(con, secuencia, paciente, codigoEnfermedad, actualiza, ""); 
		}  	
		...
		@Override
		public String cargarHoraObservacionesFamiliares(Connection con,
				int paciente) {
			return SqlBaseAntecedentesOftalmologicosDao.cargarHoraObservacionesFamiliares(con, paciente);
		}

		@Override
		public String cargarFechaObservacionesFamiliares(Connection con,
				int paciente) {
