...
public class PostgresqlPaquetizacionDao implements PaquetizacionDao 
{
	...
	public static String cadenaConsultaSolSubcuenta="SELECT " +
													...
													" getNumRespSolServicio(ss.solicitud,ss.servicio,'"+ConstantesBD.acronimoSi+"') as numresservicio," +
													" getNumRespSolArticulo(ss.solicitud,ss.articulo,'"+ConstantesBD.acronimoSi+"') as numresarticulo," +
	...
	{
		String cadena="select nextval('seq_paquetizacion') ";
	...
	public boolean guardarDetallePaquete(Connection con, HashMap vo) 
	{
		String cadenaInsertDetallePaquetizacion="INSERT INTO detalle_paquetizacion (" +
																					...
																					") " +
																					" values (nextval('seq_det_paquetizacion'),?,?,?,?,?,?,?,?,?,?,?,?,?) ";
