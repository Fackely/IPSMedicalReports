/*
 * @(#)PostgresqlSolicitudesCxDao.java
 *
 ...
 */
public class PostgresqlSolicitudesCxDao implements SolicitudesCxDao
{
     ...
     */
     private static String insertarSolicitudCxXArticuloGeneralStr="INSERT INTO articulos_sol_cirugia(codigo, numero_solicitud, cantidad) VALUES (nextval('seq_articulos_sol_cx'), ?, ?)";
     ...
     private static String cargarArticulosXSolicitudesCxStr="SELECT " +
                                                                                     ...
                                                                                     "CASE WHEN va.es_pos= '"+ ConstantesBD.valorTrueEnString +"' THEN 'POS' " +
                                                                                     ...
                                                                                     "AND va.estado='"+ ConstantesBD.valorTrueEnString +"' "+
    ...
    {
        return SqlBaseSolicitudesCxDao.insertarSolicitudCxXServicio(con, numeroSolicitud, codigoServicio, codigoTipoCirugia, 
        		consecutivo, codigoEsquemaTarifario, codigoGrupoUvr, codigoInstitucion, /*autorizacion, */finalidad, 
        		observaciones, viaCx, indBilateral, indViaAcceso, codigoEspecialidad, liquidarServicio, cubierto, codigoContrato);
    }
