...
public class PostgresqlGruposDao implements GruposDao
{
	/**
	...
	{
	    return SqlBaseGruposDao.insertarXesquemaTarifario(con, grupo, codigoAsocio, codigoEsquemaTarifario, codigoTipoLiquidacion, unidades, valor, codigoInstitucion,convenio,tipoServicio,fechaInicial,fechaFinal,usuario,codigoGrupo,esquemaGeneral,liquidarPor);
	}
