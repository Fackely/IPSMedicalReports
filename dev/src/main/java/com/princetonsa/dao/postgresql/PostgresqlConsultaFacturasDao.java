/*
 * @(#)PostgresqlActualizacionAutorizacionDao.java
 *
 ...
 */
public class PostgresqlConsultaFacturasDao implements ConsultaFacturasDao 
{
	/**
	 * Método que carga las fcturasd de una paciente cargado en session
	 * @param con
	...
	/**
	 * Método para las busuqeda de facturas (TODOS)
	 * @param con
