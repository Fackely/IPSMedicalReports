 ...
 *
 */
public class PostgresqlUtilidadesJustificacionNoPosDao implements UtilidadesJustificacionNoPosDao 
{
	/**
	...
	/* (non-Javadoc)
	 * @see com.princetonsa.dao.historiaClinica.UtilidadesJustificacionNoPosDao#insertarAsocioSolicitudJustificacion(java.sql.Connection, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.princetonsa.dao.historiaClinica.UtilidadesJustificacionNoPosDao#insertarAsocioOrdenJustificacion(java.sql.Connection, int, int, int)
	 */
