/*
* @(#)PostgresqlHorarioAtencion.java
*
...
*/
public class PostgresqlHorarioAtencionDao implements HorarioAtencionDao
{
	
	private static Logger logger=Logger.getLogger(PostgresqlHorarioAtencionDao.class);
	...
	*/
	private static final String is_cargar =
		"SELECT "	+	"DISTINCT (ha.codigo) "	+ "AS codigo," +
						...
						"substr(ha.hora_inicio,0,6) "		+ "AS horaInicio,"				+
						"substr(ha.hora_fin,0,6) "			+ "AS horaFin,"					+
	...
	* fuente de datos. No utiliza la base por que esta consulta est� optimizada para Postgresql
	*
	...
	*/
	...
	{
		return SqlBaseHorarioAtencionDao.insertarHorarioAtencion(ac_con,ai_centroAtencion, ai_unidadConsulta, ai_consultorio, ai_diaSemana, ai_codigoMedico, as_horaInicio, as_horaFin, ai_duracionConsulta, ai_pacientesSesion,DaoFactory.POSTGRESQL );
	}
