...
public class PostgresqlProrrogarAnularAutorizacionesEntSubcontratadasDao
		implements ProrrogarAnularAutorizacionesEntSubcontratadasDao {

	/**
	 * 
	 */
	public ArrayList<DtoAutorizacionEntSubContratada> listadoAutorizacionesEntSub(
			int codPaciente, int codInstitucion) {
