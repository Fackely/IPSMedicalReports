...
public class PostgresqlUtilidadJustificacionPendienteArtServDao implements UtilidadJustificacionPendienteArtServDao
{
	/**
	 * 
	 */
	 ...
	 * @return
	 */
	public HashMap obtenerResponsablesJusPendiente(Connection con, int numeroSolicitud, int codigo, boolean esArticulo)
	{
		return SqlBaseUtilidadJustificacionPendienteArtServDao.obtenerResponsablesJusPendiente(con, numeroSolicitud, codigo, esArticulo);
	}
	...
	/**
	 * Inserta un responsable para una justificación pendiente
	 * @param con
	 * @param numeroSolicitud
	 * @param servicio
	 * @param subCuenta
	...
	{
		return SqlBaseUtilidadJustificacionPendienteArtServDao.ingresarJustificacionSegunOrdenAmbulatoria(con,ordenAmbulatoria,codigo,solicitud,esArticulo, institucion, DaoFactory.POSTGRESQL);
	}
}