 ...
 * May 11, 2007
 */
public class PostgresqlDetalleCoberturaDao implements DetalleCoberturaDao
{
	...
	{
		String cadena="INSERT INTO detalle_cobertura (codigo_detalle_cob,codigo_cobertura,institucion,via_ingreso,tipo_paciente,naturaleza_paciente,usuario_modifica,fecha_modifica,hora_modifica)  values (nextval('seq_detalle_cobertura'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO cob_agrup_articulos(codigo,codigo_detalle_cob,clase,grupo,subgrupo,naturaleza,institucion,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_cob_agrup_articulo'),?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO cobertura_articulos (codigo,codigo_detalle_cob,codigo_articulo,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,usuario_modifica,fecha_modifica,hora_modifica) values (nextval('seq_cobertura_articulo'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO cob_agrup_servicios(codigo,codigo_detalle_cob,pos,possubsidiado,grupo_servicio,tipo_servicio,especialidad,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,usuario_modifica,fecha_modifica,hora_modifica) values (nextval('seq_cob_agrup_servicios'),?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO cobertura_servicios(codigo,codigo_detalle_cob,codigo_servicio,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,usuario_modifica,fecha_modifica,hora_modifica) values (nextval('seq_cobertura_servicios'),?,?,?,?,?,?,?,?)";
