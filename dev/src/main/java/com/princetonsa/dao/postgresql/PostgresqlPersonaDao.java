...
public class PostgresqlPersonaDao implements PersonaDao
{
	/**
	...
	private static final String insertarPersonaStr = "INSERT INTO personas " +
		"(codigo, numero_identificacion, tipo_identificacion, codigo_departamento_nacimiento, " +
		"codigo_ciudad_nacimiento, codigo_pais_nacimiento, tipo_persona, fecha_nacimiento, estado_civil, sexo, primer_nombre, " +
		"segundo_nombre, primer_apellido, segundo_apellido, direccion,	codigo_departamento_vivienda, " +
		"codigo_ciudad_vivienda, codigo_pais_vivienda, codigo_barrio_vivienda, codigo_localidad_vivienda, telefono, email, codigo_depto_id, codigo_ciudad_id, codigo_pais_id, telefono_celular, telefono_fijo) " +
	...
	private static final String insertarPersonaSinDocStr = "INSERT INTO personas " +
		...
		"VALUES (nextval('seq_personas'), nextval('seq_personas_sin_id'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	*/
	private static final String is_aumentarSinIdentificacion =
		"SELECT NEXTVAL('seq_personas_sin_id') AS numero_identificacion";
	...
	/**
	 * Dada una conexion abierta con una base de datos PostgreSQL y los datos basicos de
	...
	* @param codigoDeptoId							Código del departamento de la identificacion
	* @param codigoCiudadId							Código de la ciudad de identificacion
