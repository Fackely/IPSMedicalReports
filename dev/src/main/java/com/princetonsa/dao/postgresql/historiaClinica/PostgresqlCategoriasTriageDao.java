 ...
 *
 */
public class PostgresqlCategoriasTriageDao implements CategoriasTriageDao 
{
	...
	{
		String cadena="insert into categorias_triage (consecutivo,codigo,institucion,nombre,color) values (nextval('seq_categorias_triage'),?,?,?,?)";
