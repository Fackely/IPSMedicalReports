/*
 * @(#)PostgresqlRadicacionCuentasCobroCapitacionDao.java
 *
 ...
 */
public class PostgresqlRadicacionCuentasCobroCapitacionDao implements RadicacionCuentasCobroCapitacionDao 
{
	/**
