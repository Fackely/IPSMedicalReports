 ...
 * */
public class PostgresqlDocumentosGarantiaDao implements DocumentosGarantiaDao
{	
	...
	private static final String strCadenaInserccionNuevoResponsable ="INSERT INTO responsables_pacientes (" +
			...
			"hora_modifica," +
			"usuario_modifica) " +
			"VALUES (?,?,?,?,?,nextval('manejopaciente.seq_responsables_pacientes'),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
	 ...
	 * @param HashMap parametros 
	 * */
	public int insertarDeudorCo(Connection con, HashMap parametros)
	{
	 ...
	 * @param HashMap parametros
	 * */
	public HashMap consultarDeudorCo(Connection con, HashMap parametros)
	{
