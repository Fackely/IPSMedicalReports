 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>Cuenta</code>
 *
...
public class PostgresqlCuentaDao implements CuentaDao{
	 ...
	 */
	private static final String crearEntradaAsocioCuentaStr="INSERT INTO asocios_cuenta (codigo, fecha, hora, cuenta_inicial, usuario, activo,ingreso) values (nextval('seq_asocios_cuenta'), CURRENT_DATE, CURRENT_TIME, ?, ?, true,?)";
	 ...
	 * de creaciï¿½n de la cuenta en una BD Postgresql
	 * 
	 ...
	 */
	public int asociarCuenta (Connection con, int idCuenta,int ingreso, String usuario) throws SQLException
	{
		return SqlBaseCuentaDao.asociarCuenta (con, idCuenta,ingreso, usuario, crearEntradaAsocioCuentaStr);
	}
	 ...
	 * transaccional en una BD Postgresql
	 * 
	...
	{
		return SqlBaseCuentaDao.guardar(con, cuenta, "nextval('seq_cuentas')", "nextval('seq_sub_cuentas')","nextval('seq_informacion_poliza')","nextval('seq_responsables_pacientes')", DaoFactory.POSTGRESQL);
	}
