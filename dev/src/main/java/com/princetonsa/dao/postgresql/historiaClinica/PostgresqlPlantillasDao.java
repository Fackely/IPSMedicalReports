...
public class PostgresqlPlantillasDao implements PlantillasDao
{	
	...
	private static final String strInsertarDetSeccionesNuevos = "insert into " +
			...
			"fecha_modifica, " +
			"hora_modifica) " +
			"(SELECT NEXTVAL('seq_det_secciones'), codigo_pk_opciones,?,?,?,?,? " +
			"FROM det_secciones " +
	...
	{
		 SqlBasePlantillasDao.guardarPlantillaSinOrden(con, codigoPlantilla, visible, nombreSeccion, false, sexo, centroCosto, tipoFormato);
	}
	...
	{
		 SqlBasePlantillasDao.guardarPlantillaSinOrdenConsultaExterna(con, codigoPlantilla, visible, nombreSeccion, true, especialdiad);
	}
