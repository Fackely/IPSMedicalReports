 ...
 *
 */
public class PostgresqlUtilConversionMonedasDao implements UtilConversionMonedasDao
{
	/**
	 * 
	 */
	...
	{
		return SqlBaseUtilConversionMonedasDao.obtenerTiposMonedaTagMap(con, codigoInstitucion, mostrarMonedaManejaInstitucion, DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseUtilConversionMonedasDao.obtenerTipoMonedaManejaInstitucion(con, codigoInstitucion, DaoFactory.POSTGRESQL);
	}
