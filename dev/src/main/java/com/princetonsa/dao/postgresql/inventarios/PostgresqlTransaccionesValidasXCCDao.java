 ...
 */
public class PostgresqlTransaccionesValidasXCCDao implements  TransaccionesValidasXCCDao 
{
    /**
    ...
    public boolean generarInsert(Connection con,int codCC,int codTipoTrans,int codClaseInv,int codGrupoInv,int institucion)
    {
        ...
        final String insertTransaccionesValidasStr="INSERT INTO " +
														    		...
														    		"grupo_inventario," +
														    		"institucion) " +
														    		"VALUES(NEXTVAL('seq_trans_validas_x_cc_inven'),?,?,?,?,?)";
        return SqlBaseTransaccionesValidasXCCDao.generarInsert(con, codCC, codTipoTrans, codClaseInv, codGrupoInv, institucion, insertTransaccionesValidasStr, "NEXTVAL('seq_trans_validas_x_cc_inven')");
    }
    /**
