 ...
 * de datos en la funcionalidad Generación Interfaz Facturación
 */
public class PostgresqlGeneracionInterfazDao implements GeneracionInterfazDao
{
	/**
	...
	{
		campos.put("secuencia","nextval('seq_generaciones_interfaz')");
