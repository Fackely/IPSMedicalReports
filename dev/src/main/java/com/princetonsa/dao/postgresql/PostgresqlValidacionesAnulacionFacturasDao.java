/*
 * @(#)PostgresqlValidacionesAnulacionFacturasDao.java
 *
 ...
 * @author wrios
 */
public class PostgresqlValidacionesAnulacionFacturasDao implements ValidacionesAnulacionFacturasDao 
{
    /**
	* Objeto para manejar los logs de esta clase
	*/
	private static Logger logger = Logger.getLogger(PostgresqlValidacionesAnulacionFacturasDao.class);
	...
	public boolean estaFacturaEnCierreInicialCartera(Connection con, int codigoFactura)
	{
	    ...
	    try
		{
			...
			if(rs.next())
			    resp= rs.getBoolean("esFacturaCerrada");
			return resp;
		}
		catch(SQLException e)
		{
			logger.error("Error en esFacturaDeCarteraEmpresas de PostgresqlUtilidadValidacionDao: "+e);
			return false;
		}
	}
	...
	{
	    return SqlBaseValidacionesAnulacionFacturasDao.cuentaTieneAsocio(con, codigoCuenta, ValoresPorDefecto.getValorTrueParaConsultas()+"");
	}
