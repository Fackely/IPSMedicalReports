/*
 * @(#)PostgresqlInformacionParametrizableDao.java
 *
 ...
 */
public class PostgresqlInformacionParametrizableDao implements InformacionParametrizableDao
{
    /**
     ...
     * Postgresql 
     */
	private final static String insertarCampoParametrizadoStr = " INSERT INTO param_asociadas " +
															    " (codigo, " +
															    " orden, " +
															    " seccion, " +
															    " tipo, " +
															    ...
															    " alcance_campo, " +
															    " activo) " +
															    " values (nextval('seq_param_asociadas'), ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	 ...
	 * previamente por un médico para una BD Postgresql
	 * 
	 ...
	 * una BD POSTGRESQL, dado que es solo una inserción no tiene
	...
	/**
	 * Implementación de la inserción de un campo parametrizado en 
	 * una BD POSTGRESQL, soportando definir el estado de la
	 * transacción.
	 * 
	 ...
	 * parametrizado en una BD Postgresql, soportando 
