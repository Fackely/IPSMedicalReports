...
public class PostgresqlEmbarazoDao implements EmbarazoDao
{
	...
	/**
	 * Implementación de Insertar un embarazo (de antecedentes gineco-
	 * obstetricos) en una BD POSTGRESQL, soportando Transaccionalidad.
	 * 
	...
	{
		String secuencia="nextval('seq_complicaciones_gineco')";
		String secuenciaOtras="nextval('seq_compli_gineco_otra')";
	...
	/**
	 * Implementación de la cargada de hijos en una Base de Datos Postgresql
	 * 
