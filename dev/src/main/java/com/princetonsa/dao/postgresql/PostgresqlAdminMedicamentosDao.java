/*
 * @(#)PostgresqlAdminMedicamentosDao.java
 *
 ...
 */
public class PostgresqlAdminMedicamentosDao implements AdminMedicamentosDao 
{
	/**
			...
			String adelantoXNecesidad, String nadaViaOral, String usuarioRechazo)
	{
		...
		"getdespacho(?, " +
			"(SELECT numero_solicitud FROM admin_medicamentos am WHERE am.codigo=?)) AS cantidad";
	 ...
	 * @return ResulSet list
	 */
	/*public ResultSetDecorator listadoSolicitudesPorNumeroSolicitud(Connection con, int numeroSolicitud, int codigoInstitucion)
	{
		return SqlBaseAdminMedicamentosDao.listadoSolicitudesPorNumeroSolicitud(con,numeroSolicitud, codigoInstitucion);
	}*/
