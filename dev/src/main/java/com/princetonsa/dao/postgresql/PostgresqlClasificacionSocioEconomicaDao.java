/*
 * @(#)PostgresqlClasificacionSocioEconomicaDao.java
 *
 ...
 */
public class PostgresqlClasificacionSocioEconomicaDao	implements ClasificacionSocioEconomicaDao 
{
