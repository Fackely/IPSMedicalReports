 ...
 * de datos en las utilidades del módulo de HISTORIA CLINICA
 */
public class PostgresqlUtilidadesHistoriaClinicaDao implements UtilidadesHistoriaClinicaDao 
{
	/**
	...
	/**
	 * Metodo validacion Medico especialista justificaion No Pos y Ocupacion Medico Especialista
	 * @param con
	 * @param usuario
	 * @param paraArticulo
	 * @return
	...
	{
		return SqlBaseUtilidadesHistoriaClinicaDao.cargarHistoriaMenstrual(con, codigoPaciente, numeroSolicitud, DaoFactory.POSTGRESQL);
	}
	...
	*/
	...
	{
		campos.put("tipoBD", DaoFactory.POSTGRESQL);
