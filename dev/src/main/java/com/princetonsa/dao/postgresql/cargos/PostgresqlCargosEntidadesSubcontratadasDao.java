...
/**
 * Clase que m,aneja las implemenataciones de postgres para el DAO de Cargosentidadessubcontratads
 * @author Sebastián Gómez
 *
 */
public class PostgresqlCargosEntidadesSubcontratadasDao implements
