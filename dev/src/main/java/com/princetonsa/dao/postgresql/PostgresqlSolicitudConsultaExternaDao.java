/*
* @(#)PostgresqlSolicitudConsultaExternaDao.java
*
...
*/
public class PostgresqlSolicitudConsultaExternaDao implements SolicitudConsultaExternaDao
{
	/**
	...
	*/
	...
	/**
	* Inserta una solicitud de consulta externa en una BD Postgresql
	* 
	* @param ac_con				Conexión a la fuente de datos
