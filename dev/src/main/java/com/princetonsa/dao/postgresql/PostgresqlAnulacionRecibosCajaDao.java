 ...
 */
public class PostgresqlAnulacionRecibosCajaDao implements AnulacionRecibosCajaDao
{
    /**
     * @param con
     ...
     * @param codigos
     * @return
     * FIXME Corregir este método para que guarde el ingreso
     */
    ...
    {
        String cadena="insert into movimientos_abonos(codigo,paciente,codigo_documento,tipo,valor,fecha,hora,institucion,centro_atencion_duenio,ingreso, centro_atencion) (select nextval('seq_movimientos_abonos'),paciente,?,?,valor,?,?,institucion,centro_atencion_duenio,ingreso, centro_atencion from movimientos_abonos where codigo in";
