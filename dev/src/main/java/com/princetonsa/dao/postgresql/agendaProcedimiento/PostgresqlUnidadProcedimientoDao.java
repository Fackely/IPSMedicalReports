...
public class PostgresqlUnidadProcedimientoDao implements UnidadProcedimientoDao
{
	//-- Metodos
	/**
	...
	{
		unidadProcedimiento.setCadenaSecuenciaUndProceStr("NEXTVAL('seq_unidad_procedimiento')");
	...
	{
		unidadProcedimiento.setCadenaSecuenciaServicioUndProceStr("NEXTVAL('seq_servicios_undproce')");
	...
	{
		unidadProcedimiento.setCadenaSecuenciaDetServicioUndProceStr("NEXTVAL('seq_servi_det_undproce')");
