...
public class PostgresqlRolesFuncsDao implements RolesFuncsDao 
{
	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar un nuevo rol en la tabla de roles.
	 */
	private static final String insertarRolesStr = "INSERT INTO roles VALUES (nextval('seq_roles'), ?)";

	/**
	 * Este método abre una nueva conexión con una BD PostgreSQL, y retorna la conexión abierta
	...
	/**
	 * Este método abre una nueva conexión con una BD PostgreSQL, y dado el nombre de un rol,
	...
	/**
	 * Este método abre una nueva conexión con la BD PostgreSQL al iniciarse, y la cierra al salir. Toma
	 ...
	 * que dependen de una particular en una BD Postgresql
	 * 
	 ...
	 * huérfanas en una BD Postgresql
	 * 
	...
	{
	    return SqlBaseRolesFuncsDao.listaFuncionalidadesHijas(con, DaoFactory.POSTGRESQL);
	}
