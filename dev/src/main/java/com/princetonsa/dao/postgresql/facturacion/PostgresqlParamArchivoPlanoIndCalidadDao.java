...
public class PostgresqlParamArchivoPlanoIndCalidadDao implements ParamArchivoPlanoIndCalidadDao
{
	private static String insertarES="INSERT INTO ind_calidad_especialidad VALUES " +
										"(nextval('facturacion.seq_ind_calidad_especialidad')," +
										"?," +
										"?," +
										"?," +
										"?," +
	...
	private static String insertarCC="INSERT INTO ind_calidad_cc VALUES " +
										"(nextval('facturacion.seq_ind_calidad_cc')," +
										"?," +
										"?," +
										"?," +
										"?," +
	...
	private static String insertarDX="INSERT INTO ind_calidad_dx VALUES " +
										"(nextval('facturacion.seq_ind_calidad_dx')," +
										"?," +
										"?," +
										"?," +
										"?," +
