...
/**
 * Métodos de Postgres para el acceso a la fuente de datos para las utilidades
 * del módulo de ADMINISTRACION 
 * @author Jhony Alexander Duque A.
 * jduque@princetonsa.com
 *
 */
public class PostgresqlUtilidadesAdministracionDao implements UtilidadesAdministracionDao
{
	/**
