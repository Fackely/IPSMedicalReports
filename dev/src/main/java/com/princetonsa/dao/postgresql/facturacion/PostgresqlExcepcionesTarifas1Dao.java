 ...
 *
 */
public class PostgresqlExcepcionesTarifas1Dao implements ExcepcionesTarifas1Dao 
{
	...
	{
		String cadena="INSERT INTO excep_tarifas_contrato(codigo,codigo_contrato,institucion,via_ingreso,tipo_paciente,tipo_complejidad,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia,observaciones,centro_atencion) values(nextval('seq_excep_tarifas_contrato'),?,?,?,?,?,?,?,?,?,?,?)";
