 ...
 * de acceso a una base de datos postgreSQL requeridos por la clase <code>TarifasSOAT</code>

 * 
 * @version 1.0, 04-May-2004
 * @author <a href="mailto:Liliana@PrincetonSA.com">Liliana Caballero</a>
 */
public class PostgresqlTarifasSOATDao implements TarifasSOATDao
{
	/**
	...
	String liquidacionServicio, boolean buscarPorLiquidacionServicio) throws SQLException
	{
		...
		liquidacionServicio,
		buscarPorLiquidacionServicio, "::date");
	}
