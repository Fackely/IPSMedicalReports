/*
 * @(#)PostgresqlFormatoImpresionPresupuestoDao.java
 *
 ...
 */
public class PostgresqlFormatoImpresionPresupuestoDao implements FormatoImpresionPresupuestoDao
{
	/**
	...
	private static final String insertarFormatoImpresionBasicoStr=" INSERT INTO formato_imp_presupuesto " +
																  ...
																  " fecha_hora," +
																  " institucion)" +
																  " VALUES (nextval('seq_formato_imp_presupuesto'), ? , ? , ? , ? , ? , ? , ? , ? , ? , ? , ?)";
	...
	{
		return SqlBaseFormatoImpresionPresupuestoDao.modificarFormatoImpresion(con, codigoFormato, nombreFormato, tituloFormato, cantidad, descripcionCantidad, valorUnitario, descripcionValUnitario, valorTotal, descripcionValTotal, piePagina, fechaHora, mapaDetServicios, mapaDetArticulos, DaoFactory.POSTGRESQL);
	}
