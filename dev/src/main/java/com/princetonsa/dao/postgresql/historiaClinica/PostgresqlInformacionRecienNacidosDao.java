 ...
 * @author Jorge Armando Osorio Velasquez.
 */
public class PostgresqlInformacionRecienNacidosDao implements InformacionRecienNacidosDao
{
	...
	private static final String cadenaInsercionDx="INSERT INTO diag_egreso_rn (" +
													...
													"tipo_diagnostico," +
													"principal) values(nextval('seq_diag_egre_rn'),?,?,?,?,?)";
