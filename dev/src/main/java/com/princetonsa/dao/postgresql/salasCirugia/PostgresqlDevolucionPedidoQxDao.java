...
public class PostgresqlDevolucionPedidoQxDao implements DevolucionPedidoQxDao
{
	...
	{
		String consulta = "SELECT getTienePeticionDevolucPendient(?)";
		return SqlBaseDevolucionPedidoQxDao.validarPeticionDevolucionesPendientes(con, codigoPeticion,consulta);
	}
	
	/**
	 * 
	 */
	public HashMap detallePeticion(Connection con, int codigoPeticion)
    {
