/*
 * @(#)PostgresqlHistoriaClinicaDao.java
 *
 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>HistoriaClinica</code>. A diferencia de 
...
public class PostgresqlHistoriaClinicaDao implements HistoriaClinicaDao
{
