/*
 * @(#)PostgresqlUtilidadValidacionDao.java
 *
 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>UtilidadValidacion</code>
 *
 *	@version 1.0, Mar 24, 2003
 */
public class PostgresqlUtilidadValidacionDao  implements UtilidadValidacionDao
{
	/**
	 * Para hacer logs de esta clase.
	 */
	private Logger logger = Logger.getLogger(PostgresqlUtilidadValidacionDao.class);
	 ...
	 * valoraciones que hay en una cuenta en una BD Postgresql
	 *
	 ...
	 * de urgencias en una BD Postgresql
	 *
	...
	{
		String existeEvolucionConFechaSuperiorStr="SELECT ev.codigo from evoluciones ev, solicitudes sol1 where ev.valoracion=sol1.numero_solicitud and sol1.cuenta=? and ev.fecha_evolucion > '"+fechaDada+"' UNION SELECT ev.codigo from evoluciones ev, solicitudes sol2 where ev.valoracion=sol2.numero_solicitud and sol2.cuenta=? and ev.fecha_evolucion = '"+fechaDada+"' and ev.hora_evolucion >  '"+horaDada+"'";
	 ...
	 * de evolución para una cuenta en una BD Postgresql
	 *
	...
	/**
	 * Implementación del método que busca la fecha y hora máxima
	 * de valoración para una cuenta en una BD Postgresql
	 *
	 ...
	 * valoraciones para una BD Postgresql
	 *
	 ...
	 * primera valoración para una cuenta en una BD Postgresql
	 *
	 ...
	 * del día de hoy en una BD Postgresql
	 *
	 ...
	 * que pertenece una evolución en una BD Postgresql
	 *
	 ...
	 * en su sección de notas y definición para una BD Postgresql
	 *
	 ...
	 * tratante para una BD Postgresql
	 *
	 ...
	 * de acuerdo a criterios de epicrisis para una BD Postgresql
	 *
	 ...
	 * a seguir cama de observación para una BD Postgresql
	 *
	 ...
	 * hospitalización para una BD Postgresql
	 *
	 ...
	 * a un paciente en una institución para una BD Postgresql
	 *
	 ...
	 * paciente dada su identificación para una BD Postgresql
	 *
	 ...
	 * un paciente dada una institución para una BD Postgresql
	 *
	 ...
	 * una admisión hospitalaria para una BD Postgresql
	 *
	 ...
	 * de evolución para una BD Postgresql
	 *
	 ...
	 * ser finalizado para una BD Postgresql.
	 *
	 ...
	 * completo para una BD Postgresql.
	 *
	 ...
	 * egreso automático para una BD Postgresql.
	 *
	 ...
	 * si se puede ingresar un usuario para una BD Postgresql.
	 *
	...
	/**
	 * Método que implementa las validaciones necesarias para saber
	 * si se puede modificar un usuario para una BD Postgresql.
	 *
	 ...
	 * persona no usuario para una BD Postgresql.
	 *
	 ...
	 * una historia clínica para una BD Postgresql.
	 *
	 ...
	 * identificación para una BD Postgresql.
	 *
	 ...
	 * hospitalaria dado su código, para una BD Postgresql.
	 *
	...
	/**
	 * Método que implementa la revisión de si existe una admisión
	 * hospitalaria dado el código del paciente, para una BD Postgresql.
	 *
	 ...
	 * un usuario médico para una BD Postgresql.
	 *
	 ...
	 * usuario paciente para una BD Postgresql.
	 *
	 ...
	 * pacientes por institución/médico para una BD Postgresql.
	 *
	 ...
	 * el consecutivo de historias clínicas para una BD Postgresql.
	 *
	 ...
	 * un médico para una BD Postgresql.
	 *
	 ...
	 * el password de administrador para una BD Postgresql.
	 *
	 ...
	 * un egreso por tiempo para una BD Postgresql.
	 *
	...
	/**
	 * Método que implementa la revisión de si una cuenta tiene
	 * fecha de admisión para una BD Postgresql.
	 *
	 ...
	 * urgencias ya tiene asignada cama, para una BD Postgresql.
	 *
	...
	/**
	 * Método que implementa la validación de si se puede reversar
	 * un egreso de urgencias para una BD Postgresql.
	 *
	 ...
	 * persona para una BD Postgresql
	 *
	 ...
	 * de crear una cuenta en asocio para una BD Postgresql
	 *
	 ...
	 * de costo para una BD Postgresql
	 *
	 ...
	 * paciente para una institución dada en una BD Postgresql
	 *
	 ...
	 * tiene semi-egreso para una BD Postgresql
	 *
	 ...
	 * es adjunto en cuenta para una BD Postgresql
	 *
	 ...
	 * solicitudes de transferencia de manejo para una BD Postgresql
	 *
	 ...
	 * vía de ingreso consulta externa para una BD Postgresql
	 *
	 ...
	 * un adjunto en una BD Postgresql
	 *
	...
	/**
	 * Método que revisa si hay solicitudes incompletas para
	 * una cuenta en una BD Postgresql
	 *
	...
	*/
	 ...
	 * pedíatrico en una BD Postgresql
	 *
	 ...
	 * de cuentas en una BD Postgresql
	 *
	 ...
	 * de un médico en una BD Postgresql
	 *
	 ...
	 * valoración inicial para una cuenta dada en una BD Postgresql
	 *
	...
	{
		return SqlBaseUtilidadValidacionDao.buscarCodigoValoracionInicial (con, idCuenta, DaoFactory.POSTGRESQL) ;
	}
	 ...
	 * excepción para una BD Postgresql
	 *
	...
	{
		String getHoraAdmisionStr="SELECT to_char(hora_admision, 'HH24:MI') as horaAdmision from admisiones_urgencias where cuenta = ? UNION ALL SELECT to_char(hora_admision, 'HH24:MI') as horaAdmision from admisiones_hospi where cuenta =?";
	 ...
	 * antes de llenar una evolución para una BD Postgresql
	 *
	...
	{
		String sentenciaSQL="SELECT cuenta_inicial as cuentaInicial, cuenta_final as cuentaFinal from asocios_cuenta where activo=true and (cuenta_inicial IN (SELECT id from cuentas where id_ingreso =?) or cuenta_final IN (SELECT id from cuentas where id_ingreso =?) )";
	...
	{
		String cadena="SELECT getesmedicamento(?)";
	...
	*/
	...
	{
		String cantidadesString="SELECT essolmedsincant(?) AS numResultados";
	...
	{
		String consultaStr="select getPagosFacturaPaciente(?,?,?) AS valor ";
	...
	{
		String consulta = "SELECT codigo from ajustes_empresa where codigo="+codigoAjuste+" and valor_ajuste=(select sum(case when f.tipo_factura_sistema = "+ValoresPorDefecto.getValorTrueParaConsultas()+" then adfe.valor_ajuste else afe.valor_ajuste end) valor from ajus_fact_empresa afe left outer join  ajus_det_fact_empresa adfe on(adfe.codigo=afe.codigo and adfe.factura=afe.factura) inner join facturas f on (afe.factura=f.codigo) where afe.codigo="+codigoAjuste+")";
	...
	{
		String cadena="SELECT coalesce(to_char(fecha_egreso,'dd/mm/yyyy'), '') from ingresos where codigo_paciente="+codigoPersona+"  and id in(select id_ingreso from cuentas where id_ingreso=ingresos.id and estado_cuenta in ("+ConstantesBD.codigoEstadoCuentaActiva+","+ConstantesBD.codigoEstadoCuentaAsociada+","+ConstantesBD.codigoEstadoCuentaFacturada+","+ConstantesBD.codigoEstadoCuentaFacturadaParcial+"))  order by id desc "+ValoresPorDefecto.getValorLimit1()+" 1";
	...
	{
		String consulta="SELECT to_char(fecha,'dd/mm/yyyy') FROM facturas WHERE cod_paciente="+codigoPersona+" ORDER BY codigo desc "+ValoresPorDefecto.getValorLimit1()+" 1";
	...
	public InfoDatosString esPacienteCapitadoVigente(Connection con, HashMap parametros)
	{
		String strEsPacienteCapitadoVigente = "SELECT " +
												...
												"FROM (" +
														...
														"WHERE " +
															"'"+parametros.get("fechaVigencia").toString()+"' BETWEEN uxc.fecha_inicial AND uxc.fecha_final " +
															"AND p.numero_identificacion = '"+parametros.get("numeroId").toString()+"' " +
															"AND p.tipo_identificacion = '"+parametros.get("tipoId").toString()+"' " +
													")s "+ValoresPorDefecto.getValorLimit1()+" 1 ";
	...
	public double consultarSaldoPaciente(Connection con, PersonaBasica paciente) {
		try{
			...
			logger.info("Error consultando el saldo del paciente "+paciente.getNombrePersona()+" "+paciente.getCodigoTipoIdentificacionPersona()+":"+paciente.getNumeroIdentificacionPersona(), e);
			return -1;
		}
	}
				...
				"WHERE " +
					...
					"AND " +
						...
						"to_char(" +
								"CURRENT_TIMESTAMP " +
									"- " +
									"cast(substring(horas_vigencia, 1, 2) ||' hours' AS interval) " +
									"- " +
									"cast(substring(horas_vigencia, 4, 5) ||' min' AS interval), " +
								"'YYYY-MM-DD HH24:MI'" +
						")";
			PreparedStatementDecorator psd=new PreparedStatementDecorator(con, sentencia);
