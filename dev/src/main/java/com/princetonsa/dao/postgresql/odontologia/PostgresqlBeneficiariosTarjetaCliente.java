...
public class PostgresqlBeneficiariosTarjetaCliente implements BeneficiarioTarjetaClienteDao{
	...
	{
		return SqlBaseBeneficiariosTarjetaCli.consultar(tipoIdentificacion, numeroIdentificacion);
	}
