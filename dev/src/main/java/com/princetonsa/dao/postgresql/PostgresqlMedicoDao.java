 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>Medico</code>
 *
 * @version 1.0, Sep 22, 2002
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>, <a href="mailto:Camilo@PrincetonSA.com">Camilo Andr&eacute;s Camacho P.</a>
 */

public class PostgresqlMedicoDao implements MedicoDao {

	/**
	 * Inserta un medico en una base de datos PostgreSQL. Usa una conexion abierta, y la cierra
