 ...
 */
public class PostgresqlMaterialesQxDao implements MaterialesQxDao 
{
	 /**
	 * Para hacer logs de debug / warn / error de esta funcionalidad.
	 */
	private Logger logger = Logger.getLogger(PostgresqlMaterialesQxDao.class);
	...
	{
		campos.put("secuenciaFinalizacion","nextval('seq_det_fin_mat_qx')");
