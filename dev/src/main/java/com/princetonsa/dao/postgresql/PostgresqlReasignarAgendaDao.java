 ...
 *
 */
public class PostgresqlReasignarAgendaDao implements ReasignarAgendaDao 
{
	/**
	...
	{
		String insertarLogReasignacionAgenda="INSERT INTO log_reasignacion_citas (codigo,fecha_proceso,hora_proceso,usuario,cod_agenda_modificada,codigo_medico_anterior) VALUES (nextval('seq_log_reasignacion_citas'),?,?,?,?,?)";
