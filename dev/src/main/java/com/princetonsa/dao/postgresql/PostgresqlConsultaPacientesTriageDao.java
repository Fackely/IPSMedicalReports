/*
 * @(#)PostgresqlConsultaPacientesTriageDao.java
 *
 ...
 */
public class PostgresqlConsultaPacientesTriageDao implements ConsultaPacientesTriageDao 
{
	/**
	...
	{
		String restriccion = " ORDER BY pt.fecha,pt.hora DESC ";
