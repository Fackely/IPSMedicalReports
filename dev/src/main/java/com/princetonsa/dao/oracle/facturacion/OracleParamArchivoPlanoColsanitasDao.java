 ...
 *
 */
public class OracleParamArchivoPlanoColsanitasDao implements
	...
	public boolean insertarArchivoPlanoColsanitas(Connection con,
		...
		return SqlBaseParamArchivoPlanoColsanitasDao.insertarArchivoPlanoColsanitas(con, vo , DaoFactory.ORACLE);
	}
