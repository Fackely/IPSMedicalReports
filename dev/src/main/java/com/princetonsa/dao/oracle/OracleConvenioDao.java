...
{//SIN PROBAR FUNC. SECUENCIA
	 ...
	 */
	private static final String getPKConvenioAInsertarStr="SELECT seq_convenios.nextval as codigo from dual";
	...
	private final static String insertarCorreoElectronicoStr="INSERT INTO correos_convenio "+
                                                            ...
                                                            "hora_modifica, "+
                                                            "usuario_modifica) "+
															"VALUES (seq_correos_conv.nextval, ?, ?, CURRENT_DATE, "+ValoresPorDefecto.getSentenciaHoraActualBD()+", ?)";
...
//        					**************************
										...
										
	{
		...
		if(codigoConvenioAInsertar>0)
			return SqlBaseConvenioDao.insertar(	con,usuario, empresa,tipoRegimen,
												nombre,
												observaciones,
												planBeneficios,
												codigoMinSalud,
...
alo	 * para posteriorm/t ser mostrados en el pager
	 * @param con, Connection, conexi�n abierta con una fuente de datos
	...
	public ArrayList<DtoMediosAutorizacion> cargarMediosAutorizacion(
		 ...
		 return SqlBaseConvenioDao.cargarMediosAutorizacion(con, convenio, " from dual ");
	}
