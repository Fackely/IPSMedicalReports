 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OracleCajasDao implements CajasDao 
{
	/**
	...
	{
		String cadena="insert into cajas (consecutivo,codigo,institucion,descripcion,tipo,activo,centro_atencion, valor_base) values (seq_cajas.nextval,?,?,?,?,?,?,?)";
