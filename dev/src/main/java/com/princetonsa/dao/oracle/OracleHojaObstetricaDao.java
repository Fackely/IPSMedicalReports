 ...
 */
public class OracleHojaObstetricaDao implements HojaObstetricaDao
{

	/**
	 * Secuencia de la hoja obstetrica
	 */
	private final String secuencia="seq_hoja_obstetrica.nextval as codigo FROM DUAL";
	
	/**
	 * Sacuencia del resumen gestacional
	 */
	private final String secuenciaResumenGestacional="seq_resumen_gestacional.nextval as codigo FROM DUAL";
	
	/**
	 * Secuencia para los exámenes de laboratorio
	 */
	private final String secuenciaHistoricoExamenesLab="seq_historico_examenes_lab.nextval as codigo FROM DUAL";
	
	/**
	 * Secuencia para el detalle de los examenes de laboratorio 
	 */
	private final String secuenciaDetalleExamenesLab="seq_detalle_examen_lab.nextval as codigo FROM DUAL";
	
	/**
	 * Secuencia para el histórico del ultrasonido
	 */
	private final String secuenciaHistoricoUltrasonido="seq_historico_ultrasonidos.nextval as codigo FROM DUAL";
	
	/**
	 * Secuencia para el detalle otro examen de laboratorio 
	 */
	private final String secuenciaDetalleOtroExamenesLab="seq_detalle_otro_examen_lab.nextval as codigo FROM DUAL";
