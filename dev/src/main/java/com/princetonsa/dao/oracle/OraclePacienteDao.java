 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>Paciente</code>
 *
 * @version 1.0, Oct 7, 2002
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>, <a href="mailto:Camilo@PrincetonSA.com">Camilo Andr&eacute;s Camacho P.</a>
 */

public class OraclePacienteDao implements PacienteDao {

	/**
	 * Inserta un paciente en una base de datos Oracle. No termina la transacción, porque esta requiere
	...
	*/
	...
	{
		datosTriage.put("secuencia","seq_pacientes_triage.nextval");
