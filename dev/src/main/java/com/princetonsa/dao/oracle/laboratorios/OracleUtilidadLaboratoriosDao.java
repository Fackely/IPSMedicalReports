 ...
 *
 */
package com.princetonsa.dao.oracle.laboratorios;
...
/**
 * clase que contiene las diferentes utilidades de laboratorios para oracle
 * @author <a href="mailto:wilson@PrincetonSA.com">Wilson Rios/a>
 */
public class OracleUtilidadLaboratoriosDao implements UtilidadLaboratoriosDao 
{
	...
	{
		campos.put("secuencia","seq_res_sol_proc.nextval");
	...
	{
		campos.put("secuencia","seq_incon_interfaz_lab.nextval");
