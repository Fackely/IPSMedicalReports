...
public class OracleSustitutosNoPosDao implements SustitutosNoPosDao
{
	private static String consultaStr2="SELECT sub.subgrupo, " +
										...
										"art.descripcion || ' CONC: ' || art.concentracion || ' NAT: ' || na.nombre || ' - ' || CASE WHEN na.es_pos="+ValoresPorDefecto.getValorTrueParaConsultas()+" THEN 'POS' ELSE 'NOPOS' END AS descart " +
									"FROM articulo art " +
