...
public class OraclePazYSalvoCarteraPacienteDao implements PazYSalvoCarteraPacienteDao{
	
	
	/**
	 * Para el manejo de logs
	 */
	private static Logger logger = Logger.getLogger(OraclePazYSalvoCarteraPacienteDao.class);
