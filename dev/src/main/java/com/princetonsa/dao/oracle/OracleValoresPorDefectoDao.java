 ...
 * Princeton S.A.
 */
public class OracleValoresPorDefectoDao implements ValoresPorDefectoDao
{
	...
	{
		return SqlBaseValoresPorDefectoDao.consultarFacturasVarias(con,DaoFactory.ORACLE);
	}
