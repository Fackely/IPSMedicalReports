...
public class OracleCentrosAtencionDao implements CentrosAtencionDao 
{
	@Override
	public int insertarCentroAtencion(Connection con, String codigo,
			...
			String preFacturaVaria ,BigDecimal rangoInicialFacturaVaria , BigDecimal rangoFinalFacturaVaria, String codigoEntidadSubcontratada)
			throws SQLException {
		
		return SqlBaseCentrosAtencionDao.insertarCentroAtencion(con, codigo, descripcion, activo, codInstitucion, codUpgd, codInstitucionSIRC, 
				empresaInstitucion, direccion, pais, departamento, ciudad, telefono, 
				regionCobertura, categoriaAtencion, codigoInterfaz, piePaginaPresupuestoOdon, resolucion,  preFactura, rangoInicialFactura, 
				rangoFinalFactura, resolucionFacturaVaria, preFacturaVaria , rangoInicialFacturaVaria , rangoFinalFacturaVaria, codigoEntidadSubcontratada);
	}
