...
public class OracleRegistroConteoInventarioDao implements RegistroConteoInventarioDao{
	...
	public String sqlReporteRegistroConteoInventario(HashMap secciones,
		...
		String sql = "SELECT 	" +
							...
							"t.\"concentracion\" as concentracion, " +
							"t.\"forma_farmaceutica\" as forma_farmaceutica, " +
							"t.\"naturaleza\" as naturaleza, " +
							...
							"t.\"codigo_preparacion\" as codigo_preparacion, " +
							"dapa.ubicacion as ubicacion, " +
							"t.\"codigo_dapa\" as codigo_dapa," +
							"max(rci.numero_conteo) AS conteo, " +
							...
							"( " +
								"( " +
									"SELECT " +
										...
										"pti.codigo_dapa AS codigo_dapa " +
									"FROM " +
										"articulo a " +
									"INNER JOIN " +
						...
						"GROUP BY " +
							...
							"t.\"naturaleza\", " +
							"t.\"subgrupo\", " +
							"se.descripcion||' - '|| subs.descripcion," +
							"se.codigo_pk, " +
