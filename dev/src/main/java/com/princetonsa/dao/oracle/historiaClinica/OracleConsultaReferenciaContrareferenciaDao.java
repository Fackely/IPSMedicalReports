/*
 * @(#)OracleConsultaReferenciaContrareferenciaDao.java
 *
 ...
 */
public class OracleConsultaReferenciaContrareferenciaDao implements ConsultaReferenciaContrareferenciaDao 
{
	/**
	 * 
	 * @param con
