/*
 * @(#)OraclePacientesUrgenciasPorHospitalizarDao.java
 *
 ...
 */
public class OraclePacientesUrgenciasPorHospitalizarDao implements PacientesUrgenciasPorHospitalizarDao
{
	/**
