 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>MenuFilter</code>
 *
...
public class OracleMenuDao implements MenuDao 
{
	 ...
	 * correspondiente a dicho rol. Este metodo recibe una conexion abierta con una base de datos Oracle,
