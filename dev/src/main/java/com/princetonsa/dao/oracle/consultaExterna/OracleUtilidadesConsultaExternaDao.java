 ...
 */
public class OracleUtilidadesConsultaExternaDao implements
		UtilidadesConsultaExternaDao {
	...
	public 	HashMap consultarConsultoriosLibresHorarioAtencion(Connection con,
			...
			String horaFinal)
	{
		return SqlBaseUtilidadesConsultaExternaDao.consultarConsultoriosLibresHorarioAtencion(con,centroAtencion,diaSemana,horaInicio,horaFinal,"1");
	}
	...
	{
		return SqlBaseUtilidadesConsultaExternaDao.tieneProfesionalAgendaGenerada(con, codigoProfesional, DaoFactory.ORACLE);
	}
	...
	public ArrayList<DtoConsultorios> consultoriosXcentrosAtencion(
		...
		" codigo as codigo "+
		"FROM consultaexterna.consultorios where centro_atencion= ? and activo=1 ";
