 ...
 */
public class OracleMontosCobroDao implements MontosCobroDao
{//SIN PROBAR FUNC. SECUENCIA
    
	/**
	 * Sentencia para insertar montos de cobro
	 */
	private static final String insertarMontoStr="INSERT INTO montos_cobro (codigo, convenio, via_ingreso, tipo_afiliado, estrato_social, tipo_monto, valor, porcentaje, activo, vigencia_inicial) values (seq_montos_cobro.nextval, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
