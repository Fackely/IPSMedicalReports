...
public class OracleActividadesProgramasPYPDao implements ActividadesProgramasPYPDao {
	...
	{
		String sentencia="INSERT INTO actividades_programa_pyp(codigo,institucion,programa,actividad,embarazo,semanas_gestacion,requerido,archivo,activo,finalidad_consulta,finalidad_servicio,permitir_ejecutar) VALUES(seq_act_prog_pyp.nextval,?,?,?,?,?,?,?,?,?,?,?)";
