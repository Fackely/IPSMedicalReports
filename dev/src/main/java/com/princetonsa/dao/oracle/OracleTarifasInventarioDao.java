 ...
 */
public class OracleTarifasInventarioDao implements TarifasInventarioDao {

	/**
	 * Statement de inserción
	 */
	private final String insertQuery = "INSERT INTO tarifas_inventario (codigo, esquema_tarifario, articulo, valor_tarifa, porcentaje_iva, porcentaje, actualiz_automatic,tipo_tarifa, usuario_modifica, fecha_modifica, hora_modifica, fecha_vigencia) VALUES (Seq_tarifas_inventario.nextval, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

	/**
	 * Metodo para realizar la insercion de nuevas tarifas
	 */
	...
	{
		return SqlBaseTarifasInventarioDao.insertar(con, esquemaTarifario, articulo, tarifa, iva, porcentaje, actualizAutomatic, tipoTarifa, usuarioModifica, fechaModifica, horaModifica, insertQuery, fechaVigencia);
	}
	...
	/**
	 * Metodo para eliminar tarifas inventario
	 */
	...
	{
		return SqlBaseTarifasInventarioDao.buscar(con, articulo, descripcionArticulo, naturalezaArticulo, formaFarmaceutica, concentracionArticulo, esquemaTarifario, tarifa, iva, porcentaje, actualizAutomatic, tipoTarifa, institucion, remite, DaoFactory.ORACLE);
	}
	...
	{
		return SqlBaseTarifasInventarioDao.consultarTodasTarifasInventarios(con, esquemaTarifario, codArticulo, DaoFactory.ORACLE);
	}
}
