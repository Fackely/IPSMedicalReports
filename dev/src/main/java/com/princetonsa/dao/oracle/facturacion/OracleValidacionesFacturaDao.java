 ...
 *
 */
public class OracleValidacionesFacturaDao implements ValidacionesFacturaDao 
{
	...
	{
		String consulta="SELECT  getSaldoFacturaAjustes(?) as saldo from dual";
	...
	public boolean generaCargoEnSolicitud(Connection con, int numeroSolicitud)
	{
		String consulta=" SELECT "+
						"  CASE "+
						"    WHEN ordenes.esSolCargoSolicitud(?)>0 "+
						"    THEN 1 "+
						"    ELSE 0 "+
						"  END AS escargoensol "+
						"   FROM DUAL";
