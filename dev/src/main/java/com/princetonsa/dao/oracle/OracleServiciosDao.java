 ...
 * proporcionando los servicios de acceso a una base de datos Oracle 
 * requeridos por <code>Servicios</code> y <code>Servicio</code>.
 *
 * @version 1.0 Nov 27, 2003
 */
public class OracleServiciosDao implements ServiciosDao
{//SIN PROBAR FUNC. SECUENCIA

	/**
	 * 
	 */
	private static final String consultaNombreServicio="SELECT getnombreservicio(?,?) as nom from dual ";
	
	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar un servicio 
	 * en el sistema en una BD Oracle.
	 */
	private static final String insertarServicioStr="INSERT INTO servicios (codigo, especialidad, tipo_servicio, naturaleza_servicio, sexo, espos,espossubsidiado, activo, unidades_uvr, grupo_servicio, nivel, requiere_interpretacion, costo, realiza_institucion,requiere_diagnostico, portatil_asociado, atencion_odontologica,convencion,minutos_duracion) values (seq_servicios.nextval, ?, ?, ? , ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)" ;
													
	
	/**
	 * Implementación del método que inserta un servicio en una BD Oracle
	 * 
	...
	/**
	 * Implementación del método que carga todos los sexos en una BD Oracle
	 * 
