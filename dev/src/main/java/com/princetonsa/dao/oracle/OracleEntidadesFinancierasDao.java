 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OracleEntidadesFinancierasDao implements EntidadesFinancierasDao 
{
	/**
	...
	{
		String cadena="insert into entidades_financieras(consecutivo,codigo,institucion,tercero,tipo, activo) values(seq_entidades_financieras.nextval,?,?,?,?,?)";
