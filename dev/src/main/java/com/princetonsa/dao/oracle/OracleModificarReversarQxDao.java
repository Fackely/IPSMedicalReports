 ...
 */
public class OracleModificarReversarQxDao implements ModificarReversarQxDao 
{
	/**
	...
	private static final String insertarEncabezadoLogStr = "INSERT INTO " +
			...
			"VALUES " +
			"(seq_cambios_liquid_qx.nextval,?,?,?,CURRENT_DATE,"+ValoresPorDefecto.getSentenciaHoraActualBD()+",?,?)";
	...
	private static final String insertarDetalleLogStr = "INSERT INTO " +
			...
			"VALUES " +
			"(seq_det_cambios_liquid_qx.nextval,?,?,?,?,?,?,?,?,?,?,?,?) ";
