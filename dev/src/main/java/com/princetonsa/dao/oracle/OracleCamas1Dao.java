 ...
 */
public class OracleCamas1Dao implements Camas1Dao
{
    /**
	 * Inserta una cama
	 */
	...
	{
	    return SqlBaseCamas1Dao.listadoCamas1(con, codigoInstitucion,centroAtencion,DaoFactory.ORACLE);
	}
