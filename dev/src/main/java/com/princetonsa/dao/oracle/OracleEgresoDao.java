 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>Egreso</code>
 *
 * @version 1.0, May 16, 2003
 */
public class OracleEgresoDao implements EgresoDao
{
	/*/**
	 * Para manejar los logs de esta clase
	 */
	//private Logger logger = Logger.getLogger(OracleEgresoDao.class);
	 ...
	 */
	public int completarSemiEgreso (Connection con, int numeroCuenta, String loginUsuario, String acronimo, int tipocie, int tipoMonitoreo) throws SQLException
	{
		return SqlBaseEgresoDao.completarSemiEgreso (con, numeroCuenta, loginUsuario, acronimo, tipocie, tipoMonitoreo) ;
	}
