/*
 * @(#)OracleAdmisionUrgenciasDao.java
 *
 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>AdmisionUrgencias</code>
 *
...
public class OracleAdmisionUrgenciasDao implements AdmisionUrgenciasDao
{//SIN PROBAR FUNC. SECUENCIA
	 ...
	 * dado el numero de cuenta . Es específico para Oracle
	 * porque el cast 24:mi no funciona en Oracle (Todo se guarda
	 * como char(5)
	 */
	private static final String consultarBasicoAdmisionStr = "" +
	"SELECT codigo as idAdmision, to_char(fecha_admision,'YYYY-MM-DD') as fechaAdmision, hora_admision as horaAdmision, origen_admision_urgencias as origenAdmision " +
	...
	/**
	 * Este método implementa insertarAdmisionUrgencias para Oracle.
	...
	public int insertarAdmisionUrgencias(Connection con, int codigoOrigen, String fecha, String hora, int codigoMedico, /*String numeroAutorizacion, */int codigoCausaExterna, String fechaObservacion, String horaObservacion, int codigoCama, String loginUsuario, int idCuenta, String estado, String consecutivoTriage, String consecutivoFechatriage,String fechaEgresoObservacion,String horaEgresoObservacion, int institucion) throws SQLException {
	    //return SqlBaseAdmisionUrgenciasDao.insertarAdmisionUrgencias( con,  codigoOrigen,  fecha,  hora,  codigoMedico, /*numeroAutorizacion, */codigoCausaExterna,  fechaObservacion,  horaObservacion,  codigoCama,  loginUsuario,  idCuenta,  estado,  insertarAdmisionUrgenciasStr, buscarNumeroSecuenciaStr, consecutivoTriage, consecutivoFechatriage,fechaEgresoObservacion,horaEgresoObservacion) ;
	...
	/**
	 * Este método implementa modificarAdmisionUrgencias para Oracle.
	...
	/**
	 * Este método implementa cargarAdmisionUrgencias para Oracle.
	...
	* admisión de urgencias en una BD Oracle 
	*
