 ...
 * @author Wilson Rios.
 */
public class OracleOrdenesAmbulatoriasDao implements OrdenesAmbulatoriasDao 
{
	/**
	 * 
	 */
	private static String cadenaConsultaOrdenes="SELECT " +
													...
													" oa.cuenta_solicitante as cuenta," +
													" oa.centro_costo_solicita as ccsolicita," +
													" oa.ingreso as ingreso," +
	...
	{
		String cadena="INSERT INTO ordenes_ambulatorias(" +
															" codigo, consecutivo_orden, institucion, codigo_paciente, tipo_orden," +
															" pyp, urgente, fecha,  hora, estado," +
															" observaciones,centro_atencion_solicita,usuario_solicita,especialidad_solicita,fecha_confirmacion," +
														...
														"values " +
														"(" +
															" seq_ordenes_ambulatorias.nextval,?,?,?,?," +
															" ?,?,?,?,?," +
															" ?,?,?,?,?," +
															" ?,?,?,?,?," +
															" ?,?,?,?,?,?" +
	...
	/**
	 * M̩todo implementado para actualizar el estado y el numero de solicitud
	...
	/**
	 * M̩todo implementado para ingresar informacion de referencia de consulta
