 ...
 */
public class OracleMetasPYPDao implements MetasPYPDao 
{
	/**
	...
	{
		campos.put("secuencia","seq_metas_pyp.nextval");
	...
	{
		campos.put("secuencia","seq_metas_ca_pyp.nextval");
	...
	{
		campos.put("secuencia","seq_metas_ocupacion_pyp.nextval");
