 ...
 */
public class OracleSolicitudMedicamentosXDespacharDao implements SolicitudMedicamentosXDespacharDao{
	...
	public String crearConsultaMedicamentosXDespachar(Connection con, HashMap filtros) 
	{
		...
		// Rango de tiempo
		cadena += "AND (to_char(s.fecha_solicitud, 'YYYY-MM-DD') BETWEEN '"+UtilidadFecha.conversionFormatoFechaABD(filtros.get("fechaInicial")+"")+"' AND '"+UtilidadFecha.conversionFormatoFechaABD(filtros.get("fechaFinal")+"")+"') ";
