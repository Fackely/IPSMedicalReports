 ...
 */
public class OracleRegUnidadesConsultaDao implements RegUnidadesConsultaDao
{
	
	/**
     * String que almacena el Query de insercion.
     */
    private static String insertarRegUniConStr="insert into consultaexterna.unidades_consulta(codigo,descripcion,activa,especialidad,tipo_atencion,color) values(seq_unidades_consulta.nextval,?,?,?,?,?)";
    ...
    {
     return SqlBaseRegUnidadesConsultaDao.insertarRegUniCon(con,descripcion,activo,especialidad,insertarRegUniConStr,DaoFactory.ORACLE, tiposAtencion, color);
    }
	...
	{
		return SqlBaseRegUnidadesConsultaDao.insertarDetalle(con,codigoUC,servicio,especialidad);
	}
    /**
     * 
     */
    ...
    {
        return SqlBaseRegUnidadesConsultaDao.consultaAvanzada(con, Codigo, Descripcion, codServicio, Activo, especialidad,Temp,DaoFactory.ORACLE);
    }
    /**
     * 
     */
	...
	{
		return SqlBaseRegUnidadesConsultaDao.modificarServico(con,codigoT,servicioNuevo,servicioAntiguo, especialidad);
	}
