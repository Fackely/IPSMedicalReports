 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>IngresoGeneral</code>
 *
...
public class OracleIngresoGeneralDao implements IngresoGeneralDao {//SIN PROBAR FUNC. SECUENCIA
	...
	private static final String ingresarInfoAdicionalPolizaStr=" INSERT INTO informacion_poliza " +
															   ...
															   " cuenta," +
															   " convenio) " +
															   " VALUES (seq_informacion_poliza.nextval,?, ?, ?, ?, ?, ?, ?, ?)";
	
	/**
	 * Inserta en la base de datos Oracle un nuevo Ingreso General. Tiene que tener mucho cuidado en
	 * siempre insertar primero el ingreso y DESPUES la cuenta.
	 * @param con una conexión abierta con una base de datos Oracle
	...
	{
	    return SqlBaseIngresoGeneralDao.insertarIngreso(con, codigoPaciente, institucion,estado, usuario,consecutivo,anioConsecutivo,centroAtencion,pacEntidadSubcontratada,fechaIngreso,horaIngreso, "seq_ingresos.nextval",transplante) ;
	}

	/**
	 * Inserta en la base de datos Oracle un nuevo Ingreso General
	...
	{
	    return SqlBaseIngresoGeneralDao.insertarIngresoTransaccional(con, codigoPaciente, institucion, estado, estadoIngreso, usuario,consecutivo,anioConsecutivo,centroAtencion,pacEntidadSubcontratada ,fechaIngreso, horaIngreso,"seq_ingresos.nextval",transplante) ;
	}
	 ...
	 * y una conexión abierta con la base de datos Oracle
	 */
	...
	/**
	 * Modifica la información de un Ingreso General en la base de datos Oracle.
	 * @param con una conexión abierta con una base de datos Oracle
	 * @param horaIngreso hora en que se efectúa el ingreso
	 ...
	 * @param idIngreso número de identificación del ingreso
	 * @return número de ingresos modificados en la base de datos Oracle
	 */
    ...
    */
	...
	{
		return SqlBaseIngresoGeneralDao.esIngresoComoEntidadSubContratada(connection, codigoIngreso, DaoFactory.ORACLE);
	}
								...
								consulta+=" ) " +
											...
											"(" +
												"SELECT distinct " +
													...
													//@todo_oracle"getnombreviaingreso(getInfoAsocio( i.id, 1 )::integer) as nombreviaingreso, " +
													"'' as nombreviaingreso, " +
													"'' as tipopaciente, " +
													...
													"to_char(i.fecha_ingreso, 'DD/MM/YYYY') as fechaingreso, " +
													"substr(i.hora_ingreso, 1,5) as horaingreso, " +
													//@todo_oracle"getnomcentrocosto(getInfoAsocio( i.id, 3)::integer) as nombrecentrocostoingreso, " +
													"'' as nombrecentrocostoingreso, " +
													"getnomcentroatencion(i.centro_atencion) as nombrecentroatencion, " +
