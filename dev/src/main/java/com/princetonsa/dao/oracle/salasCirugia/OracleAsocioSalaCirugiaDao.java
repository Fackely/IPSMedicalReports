...
public class OracleAsocioSalaCirugiaDao implements AsocioSalaCirugiaDao
{
	...
	private static final String strInsertarAsocioSalaCirugia = " INSERT INTO " +
			"tipos_asocio(codigo,institucion,codigo_asocio,nombre_asocio,tipos_servicio,centro_costo_ejecuta,participa_cir,usuario_modifica,fecha_modifica,hora_modifica) VALUES (seq_tipos_asocio.nextval,?,?,?,?,?,?,?,?,?)";
