 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>Usuario</code>
 *
...
public class OracleUsuarioDao implements UsuarioDao 
{
	...
	/**
	 * Inserta un usuario en una base de datos Oracle. Usa una conexion abierta. Si no existe, la crea.
	...
	/**
	 * Dado un login, busca en la base de datos Oracle el usuario correspondiente y recupera sus datos.
	 ...
	 * @param con una conexion abierta con la base de datos Oracle
