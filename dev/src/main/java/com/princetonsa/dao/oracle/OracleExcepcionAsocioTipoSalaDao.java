 ...
 * de datos en la funcionalidad Parametrización de Excepciones Asocio Tipo Sala
 */
public class OracleExcepcionAsocioTipoSalaDao implements ExcepcionAsocioTipoSalaDao 
{
	/**
