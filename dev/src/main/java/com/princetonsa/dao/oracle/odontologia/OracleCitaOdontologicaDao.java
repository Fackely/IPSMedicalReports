...
public class OracleCitaOdontologicaDao implements CitaOdontologicaDao
{
	/**
	...
	public ArrayList<DtoCitaOdontologica> consultaCitaOdontologicaConsExt (Connection connection,int codigoPaciente, String fechaHoraInicial, 
		...
		return SqlBaseCitaOdontologicaDao.consultaCitaOdontologicaConsExt(connection, codigoPaciente, fechaHoraInicial, fechaHorafinal, centroAtencion, unidadConsulta, estadosCita, consultorio, tipoCita, profesionalSalud,DaoFactory.ORACLE,institucion);
	}
	...
	public ArrayList<DtoCitaOdontologica> consultarCitaOdontologicaXRango(Connection con, HashMap parametrosBusqueda, int centroAtencionUsuario) {
		String ultimoPlanTratamiento="SELECT pt.estado FROM odontologia.plan_tratamiento pt WHERE pt.codigo_paciente = co.codigo_paciente WHERE rownum<=1 ORDER BY codigo_pk DESC";
	...
	public ArrayList<DtoCitaOdontologica> consultarProxCitasPacienteXCancelacion(
			int codigoPaciente, double codigoPrograma, int ordenServicio,
			int codigoInstitucionInt, String fechaCita, String horaFinCita,
			String loginUsuario) {
	...
	@Override
	public boolean cambiarEstadoCita(Connection con, BigDecimal codigo,
			String estado, String loginUsuario) {
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.princetonsa.dao.odontologia.CitaOdontologicaDao#estaCitaEnAtencion(int, java.sql.Connection)
	 */
	@Override
