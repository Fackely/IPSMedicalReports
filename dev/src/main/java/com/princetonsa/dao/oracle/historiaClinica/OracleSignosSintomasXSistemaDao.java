/*
 * @(#)OracleSignosSintomasXSistemaDao.java
 *
 ...
 */
public class OracleSignosSintomasXSistemaDao implements SignosSintomasXSistemaDao 
{
	/**
	 * sentencia para insertar
	 */
	private static String insertarSql="insert into signos_sintomas_x_sistema (codigo, cod_mot_consulta_urg, consecutivo_signos_sintomas, consecutivo_categoria_triage, institucion) values(seq_signos_sintomas_sist.nextval, ?, ?, ?, ?) ";
