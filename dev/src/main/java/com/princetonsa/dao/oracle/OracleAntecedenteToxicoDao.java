 ...
 */
public class OracleAntecedenteToxicoDao implements AntecedenteToxicoDao
{
																	...
																	String observaciones)
	{
		String insertarPredefinidoStr = "INSERT INTO ant_toxicos_tipos "
			  ...
			  + "VALUES (?, seq_ant_toxicos_tipos.nextval, ?, ?, ?, ?, ?, ?, ?, ?, '"+Utilidades.capturarFechaBD()+"', '"+UtilidadFecha.getHoraActual()+"') ";
