/*
 * @(#)OracleDespachoMedicamentosDao.java
 *
 ...
 */
public class OracleDespachoMedicamentosDao implements DespachoMedicamentosDao
{//SIN PROBAR FUNC. SECUENCIA
	...
	private final static String insercionDespachosStr = 	"INSERT INTO despacho " +
																				...
																				"VALUES (seq_despacho.nextval, ?, CURRENT_DATE, "+ValoresPorDefecto.getSentenciaHoraActualBD()+", ?, ?, ?, '"+ConstantesBD.acronimoNo+"') ";
