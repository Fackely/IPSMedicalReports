...
public class OracleAjustesEmpresaDao implements AjustesEmpresaDao 
{
    ...
    private static String cadenaIsertarAjusteServiciosCirugiaReversion="INSERT INTO ajus_asocios_fact_empresa (" +
    																		...
    																		" ) " +
    																		" select " +
    																				" cartera.seq_ajusasodetfacemp_pk.nextval," +
    																				" ?," + //llaves
    																				" ?," +  //codigo ajuste
    																				" factura," + //factura
    ...
    private static String cadenaIsertarAjusteDetallePaqueteReversion="INSERT INTO ajus_paquetizacion_det_factura(" +
    																		...
    																		") " +
    																		" select " +
    																			" cartera.seq_ajuspaqdetfacemp_pk.nextval," +
    																			" ?," + //llaves
    																			" ?," +
    																			" factura," +
    																			" det_fac_solicitud," +
