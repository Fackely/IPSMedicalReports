 ...
 */
public class OracleValidacionesSolicitudDao implements ValidacionesSolicitudDao
{
	 ...
	 * de interconsulta es pediátrica o no en una BD Oracle
	 *
    ...
    /**
     * Implementación del método que revisa si la respuesta de una solicitud
     * de interconsulta es de odontología o no en una BD Oracle
     *
    ...
    /**
     * Implementación del método que revisa si la respuesta de una solicitud
     * de interconsulta es de oftalmología o no en una BD Oracle
     *
	 ...
	 * de cambio de médico tratante en una BD Oracle
	 *
	 ...
	 * solicitud en caso de ser consulta externa en una BD Oracle
	 *
