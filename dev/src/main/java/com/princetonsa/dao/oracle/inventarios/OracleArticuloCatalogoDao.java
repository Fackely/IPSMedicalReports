...
public class OracleArticuloCatalogoDao implements ArticuloCatalogoDao {
	...
	{
		String cadenaInsertarTarifaStr="INSERT INTO tarifas_inventario (codigo,esquema_tarifario,articulo,valor_tarifa,porcentaje_iva,tipo_tarifa,porcentaje,actualiz_automatic,usuario_modifica,fecha_modifica,hora_modifica) VALUES(seq_tarifas_inventario.nextval,?,?,?,?,?,?,?,?,?,?)";
