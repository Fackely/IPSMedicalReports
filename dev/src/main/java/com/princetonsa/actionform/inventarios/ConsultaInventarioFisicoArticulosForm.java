...
public class ConsultaInventarioFisicoArticulosForm extends ValidatorForm{
	...
	/**
	 * Codigo det_articulos_almacen (ubicacion)
	 */
	...
	/**
	 * distingue el estado y los metodos de la forma, dependiendo del filtro articulo sin movimiento inventarios ó articulos con ivnentario fisico
	 */
