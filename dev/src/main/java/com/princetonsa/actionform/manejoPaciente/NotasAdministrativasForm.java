...
public class NotasAdministrativasForm extends ValidatorForm {
	...
	public ActionErrors validate(ActionMapping mapping,
		...
		if ((estado.equals("guardar")) || (estado.equals("guardarmodificar"))) 
		{
			...
			if (UtilidadTexto.isEmpty(dto.getDescripcionNota())) {
				errores.add("error descripcion", new ActionMessage(
						"errors.required", "La descripción"));
			}
			if(!errores.isEmpty())
				setEstado("empezar");
		...
		if(estado.equals("guardarComentario"))
		{
			if (UtilidadTexto.isEmpty(dtoDet.getDescripcionNota())) {
				errores.add("error descripcion", new ActionMessage(
						"errors.required", "La descripción"));
			}
			if(!errores.isEmpty())
				setEstado("verdetalle");
		}
