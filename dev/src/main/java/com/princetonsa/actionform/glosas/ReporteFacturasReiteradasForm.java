...
public class ReporteFacturasReiteradasForm extends ValidatorForm
{
	/**
	 * Para hacer logs de esta funcionalidad.
	 */
	private Logger logger = Logger.getLogger(ReporteFacturasReiteradasForm.class);
	...
	public void reset(int codigoInstitucion)
	{
		...
		this.mostrarVolver=ConstantesBD.acronimoNo;
	}
	
	public String getMostrarVolver() {
		return mostrarVolver;
	}

	public void setMostrarVolver(String mostrarVolver) {
