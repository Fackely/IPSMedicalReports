	...
	*/
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) 
	{
		...
		if( estado != null && estado.equals("finalizar") ) 
		{
			...
			{
				tieneErrores=true;
				errores.add("horaEjecucion", new ActionMessage("errors.formatoHoraInvalido", "de ejecución"));
			}
			...
			{
				tieneErrores=true;
				errores.add("fechaEjecucion", new ActionMessage("errors.formatoFechaInvalido", "de ejecución"));
			}	
			...
			if(!tieneErrores)
			{
				...
				{
					errores.add("fechaEjecucion", new ActionMessage("errors.fechaPosteriorAOtraDeReferencia", "de ejecución", "actual"));
				}
				else
				{
					...
					// Valida que la fecha de ejecución sea mayor o igual que la fecha de solicitud
					...
					try 
					{
						...
						{
							errores.add("fechaEjecucion", new ActionMessage("errors.fechaAnteriorAOtraDeReferencia", "de ejecución", "de solicitud"));
						}
