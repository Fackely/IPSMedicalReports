...
public class ImpresionResumenAtencionesForm extends ValidatorForm implements Serializable
{
     ...
     * de acuerdo a los parï¿½metros de bï¿½squeda
     */
     ...
     * instituciï¿½n centro de costo de acuerdo a los parï¿½metros de bï¿½squeda  
     */
    ...
    */
    ...
    /**
     * Collecciï¿½n para traer el listado con los cï¿½digos histï¿½ricos, fecha registro y hora registro, usuario
    ...
    //  -----------------------------SECCION CUIDADOS ESPECIALES DE ENFERMERï¿½A-------------------------------------------------// 
    
    /**
     * Mapa que contiene el histï¿½rico de cuidados especiales de enfermerï¿½a para
    ...
    /**
     * Coleccion para traer el Listado de las especificaciones glasgow parametrizados en enfermerï¿½a
     * por centro de costo instituciï¿½n    
     */
    ...
    //------------------------------ SECCION CIRUGï¿½AS ------------------------------------------//
    /**
     * Se consultan los codigo de las peticiones de cirugï¿½a,de acuerdo a los
     * parï¿½metros de bï¿½squeda en la impresiï¿½n de la historia clï¿½nica 
     */
    private HashMap mapaCodigosPeticionCirugia;
    
    //---------------------------- SUB-SECCIï¿½N ENCABEZADOS HOJA ANESTESIA ------------------------//
    /**
     * Se consultan los encabezados de la hoja de anestesia, de acuerdo
     * a la lista de peticiones que cumplieron con los criterios de bï¿½squeda 
     */
    private HashMap mapaEncabezadosHojaAnestesia;
    
    //---------------------------- SUB-SECCIï¿½N EXAMENES LABORATORIO PREANESTESIA ------------------------//
    /**
     * Se consultan los exï¿½menes de laboratorio de la preanestesia, de acuerdo
     * a la lista de peticiones que cumplieron con los criterios de bï¿½squeda 
     */
    private HashMap mapaExamenesLaboratorioPreanestesia;
    
    //---------------------------- SUB-SECCIï¿½N EXAMENES FISICOS ------------------------//
    /**
     * Se consultan el histï¿½rico de los exï¿½menes fï¿½sicos de tipo text, de acuerdo
     * a la lista de peticiones que cumplieron con los criterios de bï¿½squeda 
     */
    private HashMap mapaHistoExamenesFisicosText;
    
    /**
     * Se consultan el histï¿½rico de los exï¿½menes fï¿½sicos de tipo text area, de acuerdo
     * a la lista de peticiones que cumplieron con los criterios de bï¿½squeda 
     */
    private HashMap mapaHistoExamenesFisicosTextArea;
    
    //---------------------------- SUB-SECCIï¿½N CONCLUSIONES ------------------------//
    /**
     * Se consultan el histï¿½rico de las conclusiones de preanestesia, de acuerdo
     * a la lista de peticiones que cumplieron con los criterios de bï¿½squeda 
     */
   ...
   //---------------------------- SUB-SECCI?N TECNICA DE ANESTESIA ----------------------//
    ...
    //---------------------------- SUB-SECCIï¿½N BALANCE DE LIQUIDOS HOJA ANESTESIA ------------------------//
    /**
     * Se consultan el histï¿½rico de balance de lï¿½quidos, de acuerdo
     * a la lista de solicitudes que cumplieron con los criterios de bï¿½squeda 
     */
    private HashMap mapaHistoBalanceLiquidosHojaAnestesia;
    
    //---------------------------- SUB-SECCIï¿½N MEDICAMENTOS HOJA ANESTESIA ------------------------//
    /**
     * Se consultan el histï¿½rico de medicamentos, de acuerdo
     * a la lista de solicitudes que cumplieron con los criterios de bï¿½squeda 
     */
	...
	/**
	 * Para Cargar Toda la informacion de Hoja Quirï¿½rgica 
	 */
...
//*************************************************************************	
	...
	public void reset()
	{
		...
		//------------------CUIDADOS ESPECIALES DE ENFERMERï¿½A----------//
