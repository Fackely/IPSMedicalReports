...
/**
 * Dto que contiene los valores totales por cada Producto o Servicio
 * 
 * @version 1.0, May 02, 2011
 * @author <a href="mailto:ricardo.ruiz@servinte.com.co">Ricardo Ruiz</a>
 * 
 */
public class DtoProductoServicioReporte implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -1142191434452214452L;
	
	
	/**
	 *Atributo que representa el codigo del grupo o clase
	 */
	private int codigo;
	
	/**
	 *Atributo que representa el nombre del producto o servicio 
	 */
	private String nombre;
	
	/**
	 * Atributo que representa el total presupuestado para el producto o servicio
	 */
	private BigDecimal totalPresupuestado;
	
	/**
	 * Atributo que representa el total ordenado para el producto o servicio
	 */
	private BigDecimal totalOrdenado;
	
	/**
	 * Atributo que representa el calculo del porcentaje de lo ordenado 
	 * de acuerdo a lo presupuestado para el Servicio o Medicamento/Insumo
	 */
	private BigDecimal porcentajeOrdenado;
	
	/**
	 * Atributo que representa el total autorizado para el producto o servicio
	 */
	...
	/**
	 * Atributo que representa el total de los cargos a la cuenta para el producto o servicio
	 */
	...
	/**
	 * Atributo que representa el total facturado para el producto o servicio
	 */
	 ...
	 */
	public DtoProductoServicioReporte(){
