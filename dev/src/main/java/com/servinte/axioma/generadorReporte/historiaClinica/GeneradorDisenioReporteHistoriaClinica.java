	...
	public ComponentBuilder<?, ?> crearComponenteEncabezadoFormatoA(Map<String, String> params) 
	{
		...
		if(params.get(IConstantesReporteHistoriaClinica.ubicacionLogo).
			...
			encabezado=	cmp.horizontalList(
					...
					cmp.image(params.get(IConstantesReporteHistoriaClinica.rutaLogo)).setDimension(200, 100)
					.setStyle(stl.style().setLeftPadding(0).setVerticalAlignment(/*VerticalAlignment.MIDDLE*/VerticalAlignment.JUSTIFIED).setHorizontalAlignment(/*HorizontalAlignment.CENTER*/HorizontalAlignment.LEFT)).setWidth(100)
						,cmp.verticalList(
		...
		if(params.get(IConstantesReporteHistoriaClinica.ubicacionLogo).
			...
			encabezado=	cmp.horizontalList(
				...
				,cmp.image(params.get(IConstantesReporteHistoriaClinica.rutaLogo)).setDimension(200, 100)
				.setStyle(stl.style().setLeftPadding(0).setVerticalAlignment(/*VerticalAlignment.MIDDLE*/VerticalAlignment.JUSTIFIED).setHorizontalAlignment(/*HorizontalAlignment.CENTER*/HorizontalAlignment.RIGHT)).setWidth(100)
			);
		}
