 ...
 *
 */
public interface ICentroCostosDAO extends IBaseDAO<DtoCentroCostosVista> {
	...
	/**
	 *  Cargar los centro de costo por via ingreso
	...
	*/
	...
	public ArrayList<DtoCentroCosto> listaCentroCostoSubAlmacenXCentroAtencion(int codigoCentroAtencion);	
