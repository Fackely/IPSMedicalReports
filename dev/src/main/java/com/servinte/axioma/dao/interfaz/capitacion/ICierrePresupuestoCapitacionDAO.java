...
/**
 * Esta clase se encarga de definir los métodos de negocio para la entidad CierrePresupuestoCapitacion
 * @author Cristhian Murillo
 */
public interface ICierrePresupuestoCapitacionDAO 
{
	...
	*/
	 ...
	 * @param proceso
	 * @param List<Calendar> meses
	 * @return ArrayList<CDtoMesesTotalServiciosArticulosValorizadosPorConvenioonvenios>
	*/
	...
	*/
	public ArrayList<DtoMesesTotalServiciosArticulosValorizadosPorConvenio> obtenerListadoMesesTotalArticulosPorNivelPorClasePorProcesoPorContrato(
							int codigoContrato, long consecutivoNivel, ClaseInventario claseInventario, String proceso, List<Calendar> meses);
