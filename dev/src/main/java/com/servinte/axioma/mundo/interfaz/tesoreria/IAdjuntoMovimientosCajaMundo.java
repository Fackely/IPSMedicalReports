...
/**
 * 
 * Define la l&oacute;gica de negocio relacionada con los Documentos Adjuntos
 * @author Diana Carolina G

 * @since 25/07/2010
 */
public interface IAdjuntoMovimientosCajaMundo {

	
	
	/**
	 * 
	 * Este m&eacute;todo se encarga de listar los Documentos adjuntos
	 * @param 
	 *
	 */
	 ...
	 * @param dtoAdjuntos
	 * @return ArrayList<DTOArchivoAdjunto> archivos que se han almacenado en el sistema.
	 * @author Yennifer Guerrero
	 */
