 ...
 * @since 29 Diciembre 2010
 */
public interface IPresupuestoExclusionesInclusionesServicio
{
	...
	/**
	 * Seleccionar o deseleccionar la promoción
	 * @param registrosContratarInclusion lista de registros de inclusión
	 * @param indexRegInclusion Índice de la inclusión
	 * @param indexConvenio Índice del convenio
	 * @param checkContratado Indica si el programa fue seleccionado o desseleccionado
...
//	 * @return
//	 */
//	public ArrayList<DtoValorAnticipoPresupuesto> validarGuardarContratar(ActionErrors errores, PersonaBasica paciente,
...
//	
	 ...
	 * Método que permite obtener los convenios que están relacionados con el 
