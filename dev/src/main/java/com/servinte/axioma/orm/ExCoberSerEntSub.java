...
/**
 * ExCoberSerEntSub generated by hbm2java
 */
public class ExCoberSerEntSub implements java.io.Serializable {
	...
	public ExCoberSerEntSub() {
	}

	public ExCoberSerEntSub(long consecutivo, Servicios servicios,
	...
	public ExCoberSerEntSub(long consecutivo,
			Usuarios usuariosByUsuarioModifica, Servicios servicios,
			ExCoberturasEntidadSub exCoberturasEntidadSub,
			Usuarios usuariosByUsuarioInactivacion, String incluye,
