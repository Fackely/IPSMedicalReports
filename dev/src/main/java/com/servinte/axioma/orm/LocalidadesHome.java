 ...
 * @see com.servinte.axioma.orm.Localidades
 * @author Hibernate Tools
 */
public class LocalidadesHome {

	private static final Log log = LogFactory.getLog(LocalidadesHome.class);
	...
	public void persist(Localidades transientInstance) {
		log.debug("persisting Localidades instance");
		try {
	...
	public Localidades merge(Localidades detachedInstance) {
		...
		try {
			Localidades result = (Localidades) sessionFactory
	...
	public Localidades findById(com.servinte.axioma.orm.LocalidadesId id) {
		log.debug("getting Localidades instance with id: " + id);
		try {
			Localidades instance = (Localidades) sessionFactory
					.getCurrentSession().get(
							"com.servinte.axioma.orm.Localidades", id);
			if (instance == null) {
	...
	public List findByExample(Localidades instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Localidades").add(
