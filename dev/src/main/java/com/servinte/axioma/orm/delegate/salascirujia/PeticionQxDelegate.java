...
public class PeticionQxDelegate extends PeticionQxHome 
{
	...
	*/
	public ArrayList<DtoResultadoConsultaProcesosCierre> consultarPeticionesServicios(DtoProcesoPresupuestoCapitado dtoFiltro)
	{
		...
		query.setParameter("tarifarioSer", Utilidades.convertirAEntero(esquemaTarServicios), Hibernate.INTEGER);
		if(dtoFiltro.getFechaInicio()!=null && dtoFiltro.getFechaFin()!=null)
		{
			query.setParameter("fechaInicio", dtoFiltro.getFechaInicio(), Hibernate.DATE);
			query.setParameter("fechaFin", dtoFiltro.getFechaFin(), Hibernate.DATE);
		}
		if(dtoFiltro.getConvenio()!=null)
			query.setParameter("codConvenio", dtoFiltro.getConvenio(), Hibernate.INTEGER);
		if(dtoFiltro.getContrato()!=null)
			query.setParameter("codContrato", dtoFiltro.getContrato(), Hibernate.INTEGER);
	...
	*/
	...
	public ArrayList<DtoResultadoConsultaProcesosCierre> consultarPeticionesArticulosAnulados(DtoProcesoPresupuestoCapitado dtoFiltro){
		...
		if(dtoFiltro.getFechaInicio() != null && dtoFiltro.getFechaFin() != null) {
			query.setParameter("fechaInicio", fechaInicioAnulacion.getTime(), Hibernate.DATE);
			query.setParameter("fechaFin", fechaFinAnulacion.getTime(), Hibernate.DATE);
		}
		if(dtoFiltro.getConvenio()!=null)
			query.setParameter("codConvenio", dtoFiltro.getConvenio(), Hibernate.INTEGER);
		if(dtoFiltro.getContrato()!=null)
