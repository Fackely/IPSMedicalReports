 ...
 * @see com.servinte.axioma.orm.Turno
...
public class TurnoHome {
	...
	public Turno merge(Turno detachedInstance) {
		...
		try {
			Turno result = (Turno) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Turno findById(int id) {
		...
		try {
			Turno instance = (Turno) sessionFactory.getCurrentSession().get(
					"com.servinte.axioma.orm.Turno", id);
			if (instance == null) {
	...
	public List findByExample(Turno instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Turno").add(
