...
/**
 * Home object for domain model class Contratos.
 * @see com.servinte.axioma.orm.Contratos
 * @author Hibernate Tools
 */
public class ContratosHome {

	private static final Log log = LogFactory.getLog(ContratosHome.class);
	...
	public void persist(Contratos transientInstance) {
		log.debug("persisting Contratos instance");
		try {
	...
	public Contratos merge(Contratos detachedInstance) {
		...
		try {
			Contratos result = (Contratos) sessionFactory.getCurrentSession()
	...
	public Contratos findById(int id) {
		...
		try {
			Contratos instance = (Contratos) sessionFactory.getCurrentSession()
					.get("com.servinte.axioma.orm.Contratos", id);
			if (instance == null) {
	...
	public List findByExample(Contratos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Contratos").add(
