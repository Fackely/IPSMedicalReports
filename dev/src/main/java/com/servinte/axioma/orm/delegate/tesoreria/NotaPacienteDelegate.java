	...
	public ArrayList<DTONotaPaciente> obtenerDevolucionAbonoPacienteConsecutivo(int codigoPaciente, BigDecimal consecutivo, String naturaleza, String parametroManejoEspecialInstiOdontologicas) {
		...
		if (parametroManejoEspecialInstiOdontologicas.equals(ConstantesBD.acronimoSi)){
			...
			criteria.setProjection(Projections.projectionList()
					...
					.add( Projections.sqlProjection("getabonodisponible(ingreso2_.codigo_paciente, id) AS saldoActual", new String[]{"saldoActual"}, new Type[]{Hibernate.DOUBLE})));
			...
			criteria.setProjection(Projections.projectionList()
					...
					.add( Projections.sqlProjection("getabonodisponible(paciente2_.codigo_paciente, null) AS saldoActual", new String[]{"saldoActual"}, new Type[]{Hibernate.DOUBLE})));
