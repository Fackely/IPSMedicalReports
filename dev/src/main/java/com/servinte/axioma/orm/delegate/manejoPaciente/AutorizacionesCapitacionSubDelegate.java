...
public class AutorizacionesCapitacionSubDelegate extends AutorizacionesCapitacionSubHome {
	...
	public ArrayList<DtoConsultaProcesoAutorizacion> obtenerAutorizacionesCapitaServiArtiInconsistentes(DtoProcesoPresupuestoCapitado dto){
		...
		query.setParameter("indicativoTemporal", ConstantesBD.acronimoNoChar, Hibernate.CHARACTER);
		query.setParameter("capitacionSub", ConstantesBD.acronimoSiChar, Hibernate.CHARACTER);
		query.setParameter("tipoTarifario", tipoTarifario, Hibernate.INTEGER);
		query.setParameter("fechaInicio", dto.getFechaInicio(), Hibernate.DATE);
		query.setParameter("fechaFin", dto.getFechaFin(), Hibernate.DATE);
		
		if(dto.getConvenio()!=null)
		{	query.setParameter("convenio",dto.getConvenio(), Hibernate.INTEGER);
			if(dto.getContrato()!=null)
				query.setParameter("contrato",dto.getContrato(), Hibernate.INTEGER);
		}
	...
	public ArrayList<DtoConsultaProcesoAutorizacion> obtenerAutorizacionesCapitacionServicios(DtoProcesoPresupuestoCapitado dto){
		...
		query.setParameter("fechaInicio", dto.getFechaInicio(), Hibernate.DATE);
		query.setParameter("fechaFin", dto.getFechaFin(), Hibernate.DATE);
		query.setParameter("estadoAutorizacion",dto.getEstadoAutorizacion(), Hibernate.STRING);
	...
	public ArrayList<DtoConsultaProcesoAutorizacion> obtenerAutorizacionesCapitacionServicioAnulada(DtoProcesoPresupuestoCapitado dto){
		...
		query.setParameter("convenio",dto.getConvenio(), Hibernate.INTEGER);
		query.setParameter("contrato",dto.getContrato(), Hibernate.INTEGER);
		query.setParameter("codigoServicio",dto.getCodServicio(), Hibernate.INTEGER);
		query.setParameter("estadoAutorizacion",dto.getEstadoAutorizacion(), Hibernate.STRING);
	...
	public ArrayList<DtoConsultaProcesoAutorizacion> obtenerAutorizacionesCapitacionArticuloAnulada(DtoProcesoPresupuestoCapitado dto){
		...
		query.setParameter("fechaInicio", dto.getFechaInicio(), Hibernate.DATE);
		query.setParameter("fechaFin", dto.getFechaFin(), Hibernate.DATE);
		query.setParameter("codigoArticulo", dto.getCodArticulo(), Hibernate.INTEGER);
		query.setParameter("convenio",dto.getConvenio(), Hibernate.INTEGER);
		query.setParameter("contrato",dto.getContrato(), Hibernate.INTEGER);
		query.setParameter("estadoAutorizacion",dto.getEstadoAutorizacion(), Hibernate.STRING);
