 ...
 * @see com.servinte.axioma.orm.TipoHabitacion
...
public class TipoHabitacionHome {
	...
	public TipoHabitacion merge(TipoHabitacion detachedInstance) {
		...
		try {
			TipoHabitacion result = (TipoHabitacion) sessionFactory
	...
	public TipoHabitacion findById(com.servinte.axioma.orm.TipoHabitacionId id) {
		log.debug("getting TipoHabitacion instance with id: " + id);
		try {
			TipoHabitacion instance = (TipoHabitacion) sessionFactory
					.getCurrentSession().get(
							"com.servinte.axioma.orm.TipoHabitacion", id);
			if (instance == null) {
	...
	public List findByExample(TipoHabitacion instance) {
		log.debug("finding TipoHabitacion instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.TipoHabitacion").add(
