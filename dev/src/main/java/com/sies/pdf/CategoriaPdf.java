...
public class CategoriaPdf {
   ...
   public  static void generarPdfCategorias(String filename, Collection categorias,  UsuarioBasico medico)
   {
...
//       String[] finalReport=null;
       String[] reportHeader = {
		...
		/*for(int l=0;l<arrayList.size();l++)
		    System.out.println("Pdf->arrayList.get+"+"("+l+")"+"->"+arrayList.get(l)+""); 
		...
		if(System.getProperty("file.separator").equals("/"))
		{
			...
			report.setReportBaseHeader(filePath+"/imagenes/logoCP.png", medico.getInstitucion(), medico.getNit(), titulo);
		}
		else
		{
			filePath=filePath.substring(0, filePath.lastIndexOf("\\", (filePath.length()-2)));
   ...
   public  static void generarPdfEnfermerasSinCategoria(String filename, Collection enfermerasLibres,  UsuarioBasico medico)
   {
       PdfReports report = new PdfReports();
       String[] reportData;
       String[] reportHeader = {
