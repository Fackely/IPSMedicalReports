...
public class OracleFichaSolicitudLaboratoriosDao implements FichaSolicitudLaboratoriosDao  {

//	private String secuenciaStr = "SELECT seq_fichas.nextval FROM dual";
	private String secuenciaStr = "SELECT seq_labs_epi.nextval FROM dual";
