...
public class PostgresqlFichaSarampionDao implements FichaSarampionDao {
    ...
    /**
     * Metodo que consulta todos los datos de una ficha de sarampion
     */
    ...
    {
    	return SqlBaseFichaSarampionDao.terminarFicha(con,codigoFichaSifilis);
    }
}
