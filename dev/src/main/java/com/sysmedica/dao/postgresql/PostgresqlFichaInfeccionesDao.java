...
public class PostgresqlFichaInfeccionesDao implements FichaInfeccionesDao {

	private String secuenciaStr = "SELECT nextval('epidemiologia.seq_fichas')";
	private String secuenciaMicro = "SELECT nextval('epidemiologia.seq_microorganismos')";
