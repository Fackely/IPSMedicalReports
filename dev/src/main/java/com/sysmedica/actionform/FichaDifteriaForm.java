        ...
        if (estado.equals("actualizar")) {
        	...
        	if (fechaUltimaDosisTransformada.trim().length()>0) {
        		if (!UtilidadFecha.validarFecha(fechaUltimaDosis)) {
	                ...
	                errores.add("Campo Fecha de Ultima Dosis no valido", new ActionMessage("errors.formatoFechaInvalido","de Ultima Dósis"));
	            }
        	...
        	if (fechaAplicacionAntitoxTransformada.trim().length()>0) {
        		if (!UtilidadFecha.validarFecha(fechaAplicacionAntitox)) {
	                ...
	                errores.add("Campo Fecha de Aplicación de Antitoxina Diftérica no valido", new ActionMessage("errors.formatoFechaInvalido","de Aplicación de Antitoxina Diftérica"));
	            }
	            else if (fechaAplicacionAntitoxTransformada.compareTo(fechaActual)>0) {
					
					errores.add("Campo Fecha de Aplicación de Antitoxina Diftérica no valido", new ActionMessage("errors.fechaPosteriorIgualActual","de Aplicación de Antitoxina Diftérica", "actual"));
				}      		
        	}
        	...
        	if (fechaOperacionBarridoTransformada.trim().length()>0) {
        		if (!UtilidadFecha.validarFecha(fechaOperacionBarrido)) {
	                ...
	                errores.add("Campo Fecha de Operación Barrido no valido", new ActionMessage("errors.formatoFechaInvalido","de Operación Barrido"));
	            }
	            else if (fechaOperacionBarridoTransformada.compareTo(fechaActual)>0) {
					
					errores.add("Campo Fecha de Operación Barrido no valido", new ActionMessage("errors.fechaPosteriorIgualActual","de Operación Barrido", "actual"));
				}      		
        	}
