...
public class PostgresqlIndicePlacaDao implements IndicePlacaDao
{
	@Override
	...
	@Override
	public Collection<HashMap<String, Object>> consultarIndicesPlacaTratamiento(
			Connection con, int codTratamiento) throws SQLException
	{
	...
	@Override
	public int insertarSectorDientePlaca(Connection con, int codIndicePlaca,
			int numeroDiente, int numeroSector) throws SQLException
	{
		return SqlBaseIndicePlacaDao.insertarSectorDientePlaca(con, codIndicePlaca, numeroDiente, numeroSector);
	}

	@Override
	public Collection<HashMap<String, Object>> consultarSectoresDientesPlaca(
			Connection con, int codIndicePlaca) throws SQLException
	{
