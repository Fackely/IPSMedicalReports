...
public class PostgresqlTratamientoOdontologiaDao implements
        TratamientoOdontologiaDao
{
    ...
    {
        String secuencia="nextval('seq_tratamiento_odo') as codigo"; 
    ...
    public int insertarTratamientoDiente(
            ...
            String      observaciones) throws SQLException
    {
        String secuencia="nextval('seq_tratamiento_diente_odo') as codigo"; 
	 ...
	 */
	@Override
	public ArrayList<TipoHallazgoCeoCop> consultarCEOCOP(Connection con,
			ArrayList<Integer> hallazgosDentales) {
