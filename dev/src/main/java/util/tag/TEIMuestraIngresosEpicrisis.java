/*
 * @(#)TEIMuestraIngresosEpicrisis.java
 *
...
/**
 * Esta clase es auxiliar de <code>TagMuestraIngresosEpicrisis</code> donde se definen
 ...
 */
public class TEIMuestraIngresosEpicrisis extends TagExtraInfo 
{
	...
	public VariableInfo[] getVariableInfo(TagData data) 
	{
		...
		return new VariableInfo[] 
		{
			...
			new VariableInfo("codigoIngreso",  "java.lang.String", true, VariableInfo.NESTED),
