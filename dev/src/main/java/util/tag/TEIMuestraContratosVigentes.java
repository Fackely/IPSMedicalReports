/*
 * @(#)TEIMuestraContratosVigentes.java
 *
...
/**
 * Esta clase es auxiliar de <code>TagMuestraContratosVigentes</code> donde se definen
 * las <i>scripting variables</i> necesarias
 * 
 * @author <a href="mailto:wilson@PrincetonSA.com">Wilson Rios
 * @version 1.0, Julio 22, 2004
 */
public class TEIMuestraContratosVigentes extends TagExtraInfo {

	/**
	 * Define las <i>scripting variables</i> usadas en TagMuestraContratosVigentes y las
