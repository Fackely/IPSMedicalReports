...
/**
 * Esta clase es auxiliar de <code>TagMuestraErroresCargo</code> donde se definen
 * las <i>scripting variables</i> necesarias
 * 
 * @author <a href="mailto:wilson@PrincetonSA.com">Wilson Rios
 * @version 1.0, Agosto 5, 2004
 */
public class TEIMuestraErroresCargo extends TagExtraInfo
{
	/**
	 * Define las <i>scripting variables</i> usadas en TagMuestraErroresCargo y las
