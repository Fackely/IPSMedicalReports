/*
 * @(#)TEIMuestraDiagnosticoAdmisionHospitalaria
 *
...
/**
 * Esta clase es auxiliar de <code>TagMuestraDiagnosticoAdmisionHospitalaria</code> y sirve para
 * definir las <i>scripting variables</i> usadas en dicha clase.
 *
 * @version 1.0, Jun 05, 2003
 */

public class TEIMuestraDiagnosticoAdmisionHospitalaria extends TagExtraInfo 
{
