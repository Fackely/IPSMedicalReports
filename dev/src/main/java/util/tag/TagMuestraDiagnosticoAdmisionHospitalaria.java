/*
 * @(#)TagMuestraDiagnosticoAdmisionHospitalaria.java
 *
 ...
 * clase <code>TEIMuestraDiagnosticoAdmisionHospitalaria</code>.
 *
...
public class TagMuestraDiagnosticoAdmisionHospitalaria extends BodyTagSupport {
	...
	/**
	 * Número de la admisión a la cual se le va a mostrar el diagnostico
	 * de ingreso
	 */
	...
	private void getData() throws JspTagException {
		...
		try {
			...
			ResultSetDecorator rs=tagDao.consultaTagMuestraDiagnosticosAdmisionHospitalizacion (con, codigoAdmision);
		...
		{
				throw new JspTagException("Error Obteniendo Los Datos De La Base De Datos En El Tag Muestra Diagnosticos Admisión Hospitalaria : " + sqle.getMessage());
		}
	 ...
	 * @param i
	 */
	public void setCodigoAdmision(int i) {
		codigoAdmision = i;
	}
