/*
 * @(#)TEIMuestraNitsEmpresasStrust.java
 *
...
/**
 * Esta clase es auxiliar de <code>TagMuestraNitsEmpresasStrust</code> donde se definen
 * las <i>scripting variables</i> necesarias
 * 
 * @author <a href="mailto:wilson@PrincetonSA.com">Wilson Rios
 * @version 1.0, Mayo 5, 2004
 */
public class TEIMuestraNitsEmpresasStrust extends TagExtraInfo {

	/**
	 * Define las <i>scripting variables</i> usadas en TagMuestraNitsEmpresasStrust y las
