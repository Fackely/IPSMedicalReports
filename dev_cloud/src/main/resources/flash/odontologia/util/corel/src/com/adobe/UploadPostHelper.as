...
package util.corel.src.com.adobe {
	 ...
	 *
         * UPDATED: Updated to work with Amazon S3.
         * 
	...
	public class UploadPostHelper {
		...
		public static function getPostData(fileName:String, byteArray:ByteArray, parameters:Object = null):ByteArray {
			...
			postData = LINEBREAK(postData);            
                        ...
                        /*
                         * The following line has been modified from the original to match
                         * the form field names required by the Amazon S3 POST API.
                         *
                         * "Filedata" has been changed to "file".
                         *
                         */
