...
public class OracleFichaLeishmaniasisDao implements FichaLeishmaniasisDao {

	private String secuenciaStr = "SELECT epidemiologia.seq_fichas.nextval FROM dual";
	private String secuenciaTam = "SELECT epidemiologia.seq_tam_lesion.nextval FROM dual";
