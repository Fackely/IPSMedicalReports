...
public class PostgresqlFichaParalisisDao implements FichaParalisisDao {

	private String secuenciaStr = "SELECT nextval('epidemiologia.seq_fichas')";
	private String secuenciaExtremidadStr = "SELECT nextval('epidemiologia.seq_extremidad')";
	private String secuenciaGrupoStr = "SELECT nextval('epidemiologia.seq_grupoedad')";
