...
public class PostgresqlAntecedentesOdontologiaDao implements AntecedentesOdontologiaDao
{
    ...
    {
        return SqlBaseAntecedentesOdontologiaDao.consultar(con, codPaciente);
    }
