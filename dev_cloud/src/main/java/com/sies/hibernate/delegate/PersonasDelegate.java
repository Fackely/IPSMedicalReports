...
public class PersonasDelegate extends PersonasHome
{
	...
	public List<DtoPersonas> buscarPersonasPorFiltro(DtoPersonas filtro)
	{
		...
		if(filtro.getTipoIdentificacion() != null && !filtro.getTipoIdentificacion().trim().isEmpty()
			...
			query.setParameter("tipoId", filtro.getTipoIdentificacion(), StandardBasicTypes.STRING);
			query.setParameter("numeroId", filtro.getNumeroIdentificacion(), StandardBasicTypes.STRING);
		}
		else{
			...
			if(segundoNombre && segundoApellido){
				...
				query=sessionFactory.getCurrentSession().createQuery(consulta);
				query.setParameter("primerNombre", filtro.getPrimerNombre(), StandardBasicTypes.STRING);
				query.setParameter("segundoNombre", filtro.getSegundoNombre(), StandardBasicTypes.STRING);
				query.setParameter("primerApellido", filtro.getPrimerApellido(), StandardBasicTypes.STRING);
				query.setParameter("segundoApellido", filtro.getSegundoApellido(), StandardBasicTypes.STRING);
			}
