 ...
 */
public class PostgresqlCuadroTurnosDao implements CuadroTurnosDao
{
    /**
    ...
    /**
     * Metodo que retorna la fecha de finalización del ultimo cuadro programado para esa
     * categoria
     * @param con
    ...
    /**
     * Metodo para consulta los turnos que se pueden asignar
     */
    ...
    /**
     * Metodo que inserta un nuevo turno
     */
    ...
    /**
     * Metodo para consultar el codigo de la asociacion de un turno en una fecha
     */
    ...
    /**
     * Metodo para actualizar un turno en la BD
     */
    ...
    /**
	 * Metodo que retorna el codigo del cuadro de turno que se esta ejecutando y que corresponde a una categoria específica
	 */
    ...
    /**
	 * Metodo que consulta toda la inf referente a un cuadro de turnos especifico
	 */
	...
	{
		//System.out.println("en el postgresql este es el codigo "+ctcodigo);
		
		return SqlBaseCuadroTurnosDao.actualizarTurnoObservacion(con, ctcodigo, codigoTurno, observacion);
	}
	
	/**
	 * Metodo que consulta lo datos para generar el reporte
	 */
	 ...
	 * @param con
	 * @param codigoCategoria
	 * @param Códigos de los turnos a Consultar
