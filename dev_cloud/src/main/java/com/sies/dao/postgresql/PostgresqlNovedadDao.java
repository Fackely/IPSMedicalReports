 ...
 * @author karenth
 */
public class PostgresqlNovedadDao implements NovedadDao {
	...
	public void modificar(Connection con, int codigoPersona, String nombre, String descripcion, boolean nomina, boolean activo)
	{
		SqlBaseNovedadDao.modificar(con, codigoPersona, nombre, descripcion, nomina, activo);
	}
	...
	/**
	 * Método para consultar una asociación específicamente
	 */
	...
	/**
	 * Método para modificar una asociación de novedad a enfermera
	 */
	 ...
	 * incluida la opción de todas las enfermeras
	 * @param con
