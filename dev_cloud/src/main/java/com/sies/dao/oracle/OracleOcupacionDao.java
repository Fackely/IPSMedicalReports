...
public class OracleOcupacionDao implements OcupacionDao{
	 ...
	 */
	private static String consultaOcupacionExisteStr="SELECT getConsultarOcupacion (?) AS existe FROM dual";
	...
	/**
	 * Metodo que consulta si existe una ocupacion
	 */
