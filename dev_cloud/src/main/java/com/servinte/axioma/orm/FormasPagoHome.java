...
/**
 * Home object for domain model class FormasPago.
 * @see com.servinte.axioma.orm.FormasPago
 * @author Hibernate Tools
 */
public class FormasPagoHome {

	private static final Log log = LogFactory.getLog(FormasPagoHome.class);
	...
	public void persist(FormasPago transientInstance) {
		log.debug("persisting FormasPago instance");
		try {
	...
	public FormasPago merge(FormasPago detachedInstance) {
		...
		try {
			FormasPago result = (FormasPago) sessionFactory.getCurrentSession()
	...
	public FormasPago findById(int id) {
		log.debug("getting FormasPago instance with id: " + id);
		try {
			FormasPago instance = (FormasPago) sessionFactory
					.getCurrentSession().get(
							"com.servinte.axioma.orm.FormasPago", id);
			if (instance == null) {
	...
	public List findByExample(FormasPago instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.FormasPago").add(
