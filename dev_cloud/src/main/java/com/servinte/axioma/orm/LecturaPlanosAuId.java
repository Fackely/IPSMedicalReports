...
/**
 * LecturaPlanosAuId generated by hbm2java
 */
public class LecturaPlanosAuId implements java.io.Serializable {

	private String tipoIdentificacion;
	private String numeroIdentificacion;
	private String numeroFactura;

	public LecturaPlanosAuId() {
	}

	public LecturaPlanosAuId(String tipoIdentificacion,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LecturaPlanosAuId))
			return false;
		LecturaPlanosAuId castOther = (LecturaPlanosAuId) other;
