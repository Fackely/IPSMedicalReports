...
/**
 * NivelRompimientoServ generated by hbm2java
 */
public class NivelRompimientoServ implements java.io.Serializable {

	private int codigo;
	private String descripcion;
	private Set detSecServFormatoFacts = new HashSet(0);

	public NivelRompimientoServ() {
	}

	public NivelRompimientoServ(int codigo, String descripcion) {
		this.codigo = codigo;
