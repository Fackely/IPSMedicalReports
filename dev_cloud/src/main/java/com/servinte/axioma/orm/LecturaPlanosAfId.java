...
/**
 * LecturaPlanosAfId generated by hbm2java
 */
public class LecturaPlanosAfId implements java.io.Serializable {

	private String tipoIdentificacion;
	private String numeroIdentificacion;
	private String numeroFactura;

	public LecturaPlanosAfId() {
	}

	public LecturaPlanosAfId(String tipoIdentificacion,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LecturaPlanosAfId))
			return false;
		LecturaPlanosAfId castOther = (LecturaPlanosAfId) other;
