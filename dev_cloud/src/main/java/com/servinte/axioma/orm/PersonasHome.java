 ...
 * @see com.servinte.axioma.orm.Personas
...
public class PersonasHome {
	...
	public void attachClean(Personas instance) {
	...
	public void delete(Personas persistentInstance) {
	...
	public Personas merge(Personas detachedInstance) {
		...
		try {
			Personas result = (Personas) sessionFactory.getCurrentSession()
	...
	public Personas findById(int id) {
		...
		try {
			Personas instance = (Personas) sessionFactory.getCurrentSession()
					.get("com.servinte.axioma.orm.Personas", id);
			if (instance == null) {
	...
	public List findByExample(Personas instance) {
		log.debug("finding Personas instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Personas").add(
