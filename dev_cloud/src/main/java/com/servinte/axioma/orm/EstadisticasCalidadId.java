...
/**
 * EstadisticasCalidadId generated by hbm2java
 */
public class EstadisticasCalidadId implements java.io.Serializable {
	...
	public EstadisticasCalidadId() {
	}

	public EstadisticasCalidadId(BigDecimal codigo, String usuarioModifica,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EstadisticasCalidadId))
			return false;
		EstadisticasCalidadId castOther = (EstadisticasCalidadId) other;
