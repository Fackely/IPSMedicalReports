...
/**
 * DetVigConRetGrupo generated by hbm2java
 */
public class DetVigConRetGrupo implements java.io.Serializable {
	...
	public DetVigConRetGrupo() {
	}

	public DetVigConRetGrupo(int consecutivo, GruposServicios gruposServicios,
