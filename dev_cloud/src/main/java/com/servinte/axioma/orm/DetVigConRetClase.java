...
/**
 * DetVigConRetClase generated by hbm2java
 */
public class DetVigConRetClase implements java.io.Serializable {
	...
	public DetVigConRetClase() {
	}

	public DetVigConRetClase(int consecutivo,
			Usuarios usuariosByUsuarioModifica,
			DetVigConRetencion detVigConRetencion, int clase, int baseMinima,
	...
	public DetVigConRetClase(int consecutivo,
			...
			Usuarios usuariosByUsuarioInactivacion, int clase, int baseMinima,
