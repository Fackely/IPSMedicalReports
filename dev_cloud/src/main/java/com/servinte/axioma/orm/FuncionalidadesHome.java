 ...
 * @see com.servinte.axioma.orm.Funcionalidades
...
public class FuncionalidadesHome {
	...
	public List findByExample(Funcionalidades instance) {
		log.debug("finding Funcionalidades instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Funcionalidades").add(
