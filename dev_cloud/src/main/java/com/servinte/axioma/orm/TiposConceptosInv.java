...
/**
 * TiposConceptosInv generated by hbm2java
 */
public class TiposConceptosInv implements java.io.Serializable {

	private int codigo;
	private String descripcion;
	private Set tiposTransInventarioses = new HashSet(0);

	public TiposConceptosInv() {
	}

	public TiposConceptosInv(int codigo, String descripcion) {
		this.codigo = codigo;
