 ...
 * @see com.servinte.axioma.orm.Departamentos
...
public class DepartamentosHome {
	...
	public Departamentos merge(Departamentos detachedInstance) {
		...
		try {
			Departamentos result = (Departamentos) sessionFactory
	...
	public Departamentos findById(com.servinte.axioma.orm.DepartamentosId id) {
		log.debug("getting Departamentos instance with id: " + id);
		try {
			Departamentos instance = (Departamentos) sessionFactory
					.getCurrentSession().get(
							"com.servinte.axioma.orm.Departamentos", id);
			if (instance == null) {
	...
	public List findByExample(Departamentos instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"com.servinte.axioma.orm.Departamentos").add(
