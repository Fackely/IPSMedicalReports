...
/**
 * LogDetEmiTarjetaClienteId generated by hbm2java
 */
public class LogDetEmiTarjetaClienteId implements java.io.Serializable {
	...
	public LogDetEmiTarjetaClienteId() {
	}

	public LogDetEmiTarjetaClienteId(long codigo, long detEmiTarjeta,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LogDetEmiTarjetaClienteId))
			return false;
		LogDetEmiTarjetaClienteId castOther = (LogDetEmiTarjetaClienteId) other;
