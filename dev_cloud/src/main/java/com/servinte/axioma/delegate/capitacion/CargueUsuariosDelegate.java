...
public class CargueUsuariosDelegate {
	...
	public List<DtoUsuariosCapitados> consultarCargueUsuarios(DtoUsuariosCapitados filtrosUsuario) throws BDException{
		...
		if(filtrosUsuario.getTipoIdentificacion()!=null&&!filtrosUsuario.getTipoIdentificacion().trim().isEmpty()
			...
			criteria.add(Restrictions.sqlRestriction("UPPER({alias}.numero_identificacion) like UPPER(?) ","%"+filtrosUsuario.getNumeroIdentificacion()+"%", StandardBasicTypes.STRING));
		}
		...
		if(filtrosUsuario.getPrimerApellido()!=null&&!filtrosUsuario.getPrimerApellido().trim().isEmpty()){
			...
			criteria.add(Restrictions.sqlRestriction("UPPER({alias}.primer_apellido) like UPPER(?) ","%"+filtrosUsuario.getPrimerApellido()+"%", StandardBasicTypes.STRING));
		}
		...
		if(filtrosUsuario.getSegundoApellido()!=null&&!filtrosUsuario.getSegundoApellido().trim().isEmpty()){
			...
			criteria.add(Restrictions.sqlRestriction("UPPER({alias}.segundo_apellido) like UPPER(?) ","%"+filtrosUsuario.getSegundoApellido()+"%", StandardBasicTypes.STRING));
		}
		...
		if(filtrosUsuario.getPrimerNombre()!=null&&!filtrosUsuario.getPrimerNombre().trim().isEmpty()){
			...
			criteria.add(Restrictions.sqlRestriction("UPPER({alias}.primer_nombre) like UPPER(?) ","%"+filtrosUsuario.getPrimerNombre()+"%", StandardBasicTypes.STRING));
		}
		...
		if(filtrosUsuario.getSegundoNombre()!=null&&!filtrosUsuario.getSegundoNombre().trim().isEmpty()){
			...
			criteria.add(Restrictions.sqlRestriction("UPPER({alias}.segundo_nombre) like UPPER(?) ","%"+filtrosUsuario.getSegundoNombre()+"%", StandardBasicTypes.STRING));
		}
