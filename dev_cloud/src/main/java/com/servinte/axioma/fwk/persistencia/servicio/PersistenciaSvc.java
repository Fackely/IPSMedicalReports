		...
		if (parameters!= null && !parameters.isEmpty()) {
			for (Entry<String, ?> entry : parameters.entrySet()) {
				if (entry.getValue() instanceof String) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.STRING);
				} else if (entry.getValue() instanceof Integer) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.INTEGER);
				} else if (entry.getValue() instanceof BigDecimal) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.BIG_DECIMAL);
				} else if (entry.getValue() instanceof BigInteger) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.BIG_INTEGER);
				} else if (entry.getValue() instanceof Boolean) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.BOOLEAN);
				} else if (entry.getValue() instanceof Byte) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.BYTE);
				} else if (entry.getValue() instanceof char[]) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.CHAR_ARRAY);
				} else if (entry.getValue() instanceof Character) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.CHARACTER);
				} else if (entry.getValue() instanceof Character[]) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.CHARACTER_ARRAY);
				} else if (entry.getValue() instanceof Date) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.DATE);
				} else if (entry.getValue() instanceof Double) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.DOUBLE);
				} else if (entry.getValue() instanceof Float) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.FLOAT);
				} else if (entry.getValue() instanceof Long) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.LONG);
				} else if (entry.getValue() instanceof Short) {
					query.setParameter(entry.getKey(), entry.getValue(), StandardBasicTypes.SHORT);
