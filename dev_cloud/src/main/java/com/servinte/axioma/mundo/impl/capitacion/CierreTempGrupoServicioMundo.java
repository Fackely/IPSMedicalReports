 ...
 * @since 7/02/2011
 */
public class CierreTempGrupoServicioMundo implements
		ICierreTempGrupoServicioMundo {
	
	
	ICierreTempGrupoServicioDAO dao;
	 ...
	 * @author, Angela Maria Aguirre
	 */
	public CierreTempGrupoServicioMundo(){
		dao  =  CapitacionFabricaDAO.crearCierreTempGrupoServicioDAO();
	}
