...
/**
 * Define la l&oacute;gica de negocio relacionada con las Solicitudes
 * 
 * @author Cristhian Murillo
 * @see com.servinte.axioma.mundo.impl.tesoreria.SolicitudTrasladoCajaMundo
 */

public interface ISolicitudTrasladoCajaMundo {
	...
	/**
	 * Verifica si la caja tiene solicitudes de traslado pendiente
	 * @param caja
	 * @return
	 */
	boolean tieneSolicitudDeTraslado(Cajas caja);
