...
{    
	...
	{
		return UtilidadTexto.isEmpty(this.getResultSet().getString(columnIndex)+"")?"":this.getResultSet().getString(columnIndex).replaceAll(" 0.0.0.0", "");
	}
	...
	public String getString(String columnLabel) throws SQLException {
		return UtilidadTexto.isEmpty(this.getResultSet().getString(columnLabel)+"")?"":this.getResultSet().getString(columnLabel);
	}
	
	public String getString2(String columnLabel) throws SQLException {
		return UtilidadTexto.isEmpty2(this.getResultSet().getString(columnLabel)+"")?"":this.getResultSet().getString(columnLabel);
	}
	...
	protected void finalize() throws Throwable
	{
		try {
	    	...
	    	Log4JManager.error("FINALIZANDO ResultSetDecorator : " + e);
	    } finally {
	    	super.finalize();
	    }
	}
