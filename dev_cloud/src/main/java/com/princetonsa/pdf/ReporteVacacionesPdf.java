...
public class ReporteVacacionesPdf
{
    ...
    */
   public  static void generarPDF(String filename, UsuarioBasico usuario, Collection novedades, String fechaInicio, String fechaFin, int opcionConsulta, String nombreEnfermera, HttpServletRequest request)
   {
