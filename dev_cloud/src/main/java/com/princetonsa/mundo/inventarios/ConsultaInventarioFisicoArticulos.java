 ...
 *
 */
public class ConsultaInventarioFisicoArticulos {
...
// --------------- 	ATRIBUTOS
	...
	/**
	 * codigo det_articulos_alamacen (ubicacion)
	 */
	private int codigoDapa;
	...
	/**
	 *codigos del registro conteo 
	 */
	private String codigosRegConteo;
	 ...
	 *
	 */
	public ConsultaInventarioFisicoArticulos()
	{
		this.reset();
	...
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getConsultaInventarioFisicoArticulosDao().filtrarArticulos(con, cuc);
	}
	...
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getConsultaInventarioFisicoArticulosDao().consultarConteosArticulo(con, cuc);
	}
	...
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getConsultaInventarioFisicoArticulosDao().consultarPreparacionesArticulo(con, cuc);
	}
	...
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getConsultaInventarioFisicoArticulosDao().consultarUbicacionArticulo(con, cuc);
	}
	...
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getConsultaInventarioFisicoArticulosDao().consultarAjusteArticulo(con, cuc);
	}
	...
	public static void setArticulosPorAlmacenDao(
		...
		ConsultaInventarioFisicoArticulos.articulosPorAlmacenDao = articulosPorAlmacenDao;
	}
	...
	public static void setLogger(Logger logger) {
		ConsultaInventarioFisicoArticulos.logger = logger;
	}
	...
	/**
	 * @return the codigoDapa
	 */
	public int getCodigoDapa() {
		return codigoDapa;
	}

	/**
	 * @param codigoDapa the codigoDapa to set
	 */
	public void setCodigoDapa(int codigoDapa) {
		this.codigoDapa = codigoDapa;
	}
	...
	public String getCodigosRegConteo() {
		return codigosRegConteo;
	}

	public void setCodigosRegConteo(String codigosRegConteo) {
		this.codigosRegConteo = codigosRegConteo;
	}
