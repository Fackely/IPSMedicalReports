 ...
 *
 */
public class FormatoJustArtNopos {
	...
	/**
	 * String que almacena el numero de la orden ambulatoria
	 */	
	private String codigoOrden;

	/**
	 * boolean que indica de donde proviene la justificacion
	 */	
...
//parametros enviados desde el emisor
	 ...
	 * @return
	 */
	public static HashMap<String, Object> SubCuentas (Connection con, int numeroSolicitudOrden, int art, boolean esArticulo, boolean esOrdenAmbulatoria)
	{
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getFormatoJustArtNoposDao().subCuentas(con, numeroSolicitudOrden, art, esArticulo, esOrdenAmbulatoria);
	}
    ...
    public static Integer consultarCodigoJustificacionSolicitud(Connection con,int codigoSolicitud,int codigoArticulo){
		...
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getFormatoJustArtNoposDao().consultarCodigoJustificacionSolicitud(con,codigoSolicitud, codigoArticulo);
	 ...
	 * @return
	 */
	public String[] requiereJustificacionArticulo(Connection con, String idIngreso, int codigoUltimaViaIngreso, String idCuenta)
	{
 ...
 */	
	 ...
	 * @return 
	 */
	public List<DtoAccionCampo> consultarAccionesCampo(Connection con,int idCampo,String servicio) {
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getFormatoJustArtNoposDao().consultarAccionesCampo(con, idCampo,servicio);
	}
	...
	public String consultarObservacionesResumenNoPOS(Connection con,
		...
		return DaoFactory.getDaoFactory(System.getProperty("TIPOBD")).getFormatoJustArtNoposDao().consultarObservacionesResumenNoPOS(con, codigoSolicitudOrden, codigoArticulo, esOrdenAmbulatoria);
	}
