/*
 * @(#)PostgresqlFormatoImpresionFacturaDao.java
 *
...
public class PostgresqlFormatoImpresionFacturaDao implements FormatoImpresionFacturaDao
{
	...
	private static final String insertarFormatoImpresionBasicoStr=" INSERT INTO formato_impresion_factura " +
																  ...
																  " institucion) " +
																  " VALUES (nextval('seq_formato_impresion_factura'), ? , ? , ? , ? , ? )";
