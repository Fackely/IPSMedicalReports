 ...
 *
 */
public class PostgresqlFactorConversionMonedasDao implements FactorConversionMonedasDao 
{
	/**
	 * Consulta  
	 * @param con
	...
	{
		return SqlBaseFactorConversionMonedasDao.insertar(con, dtoFactor,DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseFactorConversionMonedasDao.modificar(con, dtoFactor, DaoFactory.POSTGRESQL);
	}
}
