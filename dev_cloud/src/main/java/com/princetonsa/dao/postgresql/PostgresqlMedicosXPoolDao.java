 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>MedicosXPool</code>
 *
 * @version 1.0, 29/11/2004
 * @author <a href="mailto:joan@PrincetonSA.com">Joan Lopez</a>
 */
public class PostgresqlMedicosXPoolDao implements MedicosXPoolDao 
{
	/**
	...
	private static String insertarMedicosXPoolStr = "INSERT INTO participaciones_pooles" +
																						...
																						"VALUES (NEXTVAL('seq_part_pooles'),?,?,CURRENT_TIME,?,?,?,?)";
    /**
