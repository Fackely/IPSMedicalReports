 ...
 * PostgresqlCoberturasConvenioDao
 ...
 * May 17, 2007
 */
public class PostgresqlCoberturasConvenioDao implements CoberturasConvenioDao
{
	/**
	 * 
	 */
	...
	{
		String cadena="INSERT INTO exep_para_cob_x_convcont(codigo,codigo_contrato,institucion,via_ingreso,tipo_paciente,naturaleza_paciente,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_exep_para_cob_x_convcont'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agrup_art_exep_cob_convxcont(codigo,codigo_excepcion,clase,grupo,subgrupo,naturaleza,institucion,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,presentar_factura_compra,incluido,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_agru_art_exp_cob_convxcont'),?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO art_exp_cob_convxcont (codigo,codigo_excepcion,codigo_articulo,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,presentar_factura_compra,incluido,usuario_modifica,fecha_modifica,hora_modifica) values (nextval('seq_art_exp_cob_convxcont'),?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO serv_exe_cob_convxcont(codigo,codigo_excepcion,codigo_servicio,requiere_autorizacion,semanas_min_cotizacion,cantidad_max_cub_x_ingreso,incluido,usuario_modifica,fecha_modifica,hora_modifica) values (nextval('seq_serv_exe_cob_convxcont'),?,?,?,?,?,?,?,?,?)";
