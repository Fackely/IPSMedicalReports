 ...
 * May 7, 2007
 */
public class PostgresqlComponentesPaquetesDao implements ComponentesPaquetesDao
{
	/**
	 * 
	 */
	...
	{
		String cadena="INSERT INTO paq_agrupacion_articulos (codigo_paq_agrup_articulo,codigo_paquete,institucion,clase,grupo,subgrupo,naturaleza,cantidad,usuario_modifica,fecha_modifica,hora_modifica,grupo_especial_articulo) values (nextval('seq_paq_agrup_art'),?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO paq_comp_articulos (codigo_paq_articulo,codigo_paquete,institucion,codigo_articulo,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_paq_comp_art'),?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO paq_agrupacion_servicios (codigo_paq_agrup_servicio,codigo_paquete,institucion,grupo_servicio,tipo_servicio,especialidad,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_paq_agrupacion_serv'),?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO paq_comp_servicios (codigo_paq_servicio,codigo_paquete,institucion,codigo_servicio,principal,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values(nextval('seq_paq_comp_serv'),?,?,?,?,?,?,?,?)";
