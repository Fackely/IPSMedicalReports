 ...
 * de datos en la funcionalidad Reporte Estadísticos de Egresos y Estancias
 */
public class PostgresqlReporteEgresosEstanciasDao implements ReporteEgresosEstanciasDao 
{
	/**
	...
	{
		return SqlBaseReporteEgresosEstanciasDao.obtenerConsultaReporteEgresosConvenio(campos, DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseReporteEgresosEstanciasDao.obtenerConsultaReporteEgresosLugarResidencia(campos, DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseReporteEgresosEstanciasDao.obtenerDiagnosticosPrioridadEgresos(con, campos, DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseReporteEgresosEstanciasDao.obtenerConsultaReporteNPrimerasCausasMorbilidad(campos, DaoFactory.POSTGRESQL);
	}
