...
public class PostgresqlRecaudoCarteraEventoDao implements RecaudoCarteraEventoDao
{
	/**
	...
	{
		return SqlBaseRecaudoCarteraEventoDao.consultaReporteResumidoXTipoConvenio(connection, criterios);
	}
	...
	{
		return SqlBaseRecaudoCarteraEventoDao.consultarReporteResumidoXConvenio(connection, criterios);
	}
	...
	{
		return SqlBaseRecaudoCarteraEventoDao.insertarLog(connection, criterios);
	}
