...
public class PostgresqlImpresionResumenAtencionesDao implements
...
/**
	...
	{
		return SqlBaseImpresionResumenAtencionesDao.consultarInformacion(con, mp, DaoFactory.POSTGRESQL);
	}
