...
public class PostgresqlRegistrarModificarGlosasDao implements RegistrarModificarGlosasDao
{
	/**
	...
	{
		return SqlBaseRegistrarModificarGlosasDao.consultaFechaRadicacion(con, codFactura, DaoFactory.POSTGRESQL);
	}
	...
	{
		return SqlBaseRegistrarModificarGlosasDao.consultaFechaRadiCC(con, codFactura, codGlosa, DaoFactory.POSTGRESQL);
	}
