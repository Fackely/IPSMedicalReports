 ...
 * de datos en las utilidades del módulo de FACTURACION
 */
public class PostgresqlUtilidadesFacturacionDao implements UtilidadesFacturacionDao 
{
	...
	{
		return SqlBaseUtilidadesFacturacionDao.cargarEstratosSociales(con, campos, DaoFactory.POSTGRESQL);
	}
	...
	public void insertarLogAdconsta(Connection con, String loginUsuario, String resultado) 
	{
		String consulta="INSERT INTO log_adconsta " +
						...
						"usuario, " +
						"indicativo)" +
						"VALUES (nextval('seq_log_adconsta'),?,?,?,?,?,? ) ";
	...
	public HashMap cargarTiposAfiliado(Connection con, HashMap campos) {
		return SqlBaseUtilidadesFacturacionDao.cargarTiposAfiliado(con, campos, DaoFactory.POSTGRESQL);
	}
	
	@Override
	public HashMap cargarTiposAfiliadoxEstrato(Connection con, HashMap campos) {
		return SqlBaseUtilidadesFacturacionDao.cargarTiposAfiliadoXEstrato(con, campos, DaoFactory.POSTGRESQL);
	}
