 ...
 * Princeton S.A.
 */
public class PostgresqlActivacionCargosDao implements ActivacionCargosDao
{
	...
	{
		campos.put("secuenciaSolicitudesSubCuenta","nextval('seq_sol_sub_cuentas')");
		campos.put("secuenciaDetCargos","nextval('seq_det_cargos')");
		campos.put("secuenciaInactivacionesCargos","nextval('seq_inactivaciones_cargos')");
