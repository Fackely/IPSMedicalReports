/*
 * @(#)PostgresqlGrupoEtareoCrecimientoDesarrolloDao.java
 *
 ...
 */
public class PostgresqlGrupoEtareoCrecimientoDesarrolloDao implements GrupoEtareoCrecimientoDesarrolloDao 
{
	...
	private static final String insertarGrupoEtareoStr = " INSERT INTO grup_etareo_creci_desa " +
													     ...
													     " activo, " +
													     " institucion) " +
													     " VALUES (nextval('seq_grup_etareo_creci_desa'), ?, ?, ?, ?, ?, ?, ?, ?) ";
