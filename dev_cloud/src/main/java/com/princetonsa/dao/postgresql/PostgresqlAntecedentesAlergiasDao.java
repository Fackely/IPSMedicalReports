/*
 * @(#)PostgresqlAntecedentesAlergiasDao.java
 *
 ...
 */
public class PostgresqlAntecedentesAlergiasDao implements AntecedentesAlergiasDao
{
	
	/**
	 * Implementación de la inserción de antecedentes alergias para
	 * una BD Postgresql (Transaccionalidad se debe manejar en capa más arriba) 
	 * 
	 ...
	 * una BD Postgresql (Transaccionalidad se maneja en capa más arriba) 
	 * 
	...
	/**
	 * Implementación de la carga de antecedentes alergias en una BD Postgresql
	 * 
	...
	/**
	 * Implementación de la carga de alergias predefinidas en una BD Postgresql
	 * 
	...
	/**
	 * Implementación de la carga de alergias adicionales en una BD Postgresql
	 * 
