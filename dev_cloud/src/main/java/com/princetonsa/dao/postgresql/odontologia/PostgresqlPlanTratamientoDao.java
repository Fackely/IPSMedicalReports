...
public class PostgresqlPlanTratamientoDao implements PlanTratamientoDao {
	...
	public ArrayList<InfoHallazgoSuperficie> obtenerHallazgosSuperficies(
			...
			boolean utilizaProgramas,String porConfirmar, boolean cargaServicios, BigDecimal codigoPkPresupuesto , int institucion) {
	...
	/**
	  ...
	  */
		 ...
		 * 
		 * (non-Javadoc)
		 * @see com.princetonsa.dao.odontologia.PlanTratamientoDao#modificar(com.princetonsa.dto.odontologia.DtoPlanTratamientoOdo, com.princetonsa.dto.odontologia.DtoPlanTratamientoOdo)
		 */
		@Override
	...
	@Override
	public ArrayList<DtoPlanTratamientoOdo> consultarPlanTratamiento(Connection con,	DtoPlanTratamientoOdo parametros, ArrayList<String> estadosPlan) {
	...
	public ArrayList<InfoHallazgoSuperficie> obtenerHallazgosSuperficiesHistoricos(
																					...
																					boolean utilizaProgramas, 
																					DtoProgramasServiciosPlanT dtoProgramasServ,
																					int institucion) 
	{
		
		return SqlBasePlanTratamientoDao.obtenerHallazgosSuperficiesHistoricos(dtoPlanTratamiento, dtoDetallePlan, utilizaProgramas, dtoProgramasServ , institucion);
	}
	...
	public ArrayList<InfoProgramaServicioPlan> consultarProximaCitaProgramasServicios(
			DtoOdontograma dtoOdongrama, DtoPlanTratamientoOdo dtoPlanTrata,
			int institucion) {
	 ...
	 */
	@Override
	public BigDecimal obtenerCodigoPkUltimaCitaProgServPlanT(
			BigDecimal codigoPkProgServPlanT,
