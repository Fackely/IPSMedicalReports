...
public class PostgresqlGenerarAgendaOdontologicaDao implements GenerarAgendaOdontologicaDao
{
	/**
	...
	{
		return SqlBaseGenerarAgendaOdontologicaDao.existeConsultoriosAgendados(con, 
				consultorio, dia, fecha, horaInicio, horaFin, centroAtencion);
	}
