...
public class PostgresqlConsumosFacturadosDao implements ConsumosFacturadosDao
{

	public HashMap generarArchivoPlano(Connection con, HashMap vo)
    {
        return SqlBaseConsumosFacturadosDao.generarArchivoPlano(con, vo, DaoFactory.POSTGRESQL);
    }
	...
	public String obtenerCondiciones(String codigoCentroAtencion,
		...
		return SqlBaseConsumosFacturadosDao.obtenerCondiciones(codigoCentroAtencion,
