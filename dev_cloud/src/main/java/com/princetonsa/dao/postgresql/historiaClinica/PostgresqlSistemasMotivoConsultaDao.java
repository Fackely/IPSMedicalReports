/*
 * @(#)PostgresqlSistemasMotivoConsultaDao.java
 *
 ...
 */
public class PostgresqlSistemasMotivoConsultaDao implements SistemasMotivoConsultaDao 
{
	...
	private final static String insertarMotivoConsultaUrgStr = " INSERT INTO motivo_consulta_urg " +
														  	   ...
														  	   " descripcion, " +
															   " institucion ) " +
														 	   " VALUES (nextval('seq_motivo_consulta_urg'), ?, ?, ? )" ;
