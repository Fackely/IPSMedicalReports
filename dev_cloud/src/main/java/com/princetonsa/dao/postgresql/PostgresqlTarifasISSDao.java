 ...
 * de acceso a una base de datos postgreSQL requeridos por la clase <code>TarifasISS</code>

 * 
 * @version 1.0, 04-May-2004
 * @author <a href="mailto:Liliana@PrincetonSA.com">Liliana Caballero</a>
 */
public class PostgresqlTarifasISSDao implements TarifasISSDao
{
	/**
																		...
																		int institucion) throws SQLException
	{
		...
		return SqlBaseTarifaISSDao.consultar(con,
					...
					liqAsocios,buscarPorLiqAsocios, institucion, "::date");	
	}
