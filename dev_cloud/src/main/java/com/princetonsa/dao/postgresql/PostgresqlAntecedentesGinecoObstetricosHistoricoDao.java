/*
 * @(#)PostgresqlAntecedentesGinecoObstetricosHistoricoDao.java
 *
 ...
 */
public class PostgresqlAntecedentesGinecoObstetricosHistoricoDao implements AntecedentesGinecoObstetricosHistoricoDao
{
	/**
