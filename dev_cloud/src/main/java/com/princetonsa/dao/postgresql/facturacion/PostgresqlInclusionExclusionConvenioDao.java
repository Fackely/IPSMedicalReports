 ...
 * PostgresqlInclusionExclusionConvenioDao
 ...
 * May 23, 2007
 */
public class PostgresqlInclusionExclusionConvenioDao implements
		InclusionExclusionConvenioDao
{
	...
	{
		String cadena="INSERT INTO excep_incluexclu_contr(codigo,codigo_contrato,institucion,codigo_centro_costo,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values(nextval('seq_excep_incluexclu_contr'),?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agru_art_incluexclu_econt(codigo,codigo_excepcion,clase,grupo,subgrupo,naturaleza,institucion,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values(nextval('seq_agru_art_incluexclu_econt'),?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO art_incluexclu_econt (codigo,codigo_excepcion,codigo_articulo,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_art_incluexclu_econt'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agru_ser_incluexclu_econt(codigo,codigo_excepcion,pos,grupo_servicio,tipo_servicio,especialidad,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_agru_ser_incluexclu_econt'),?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO ser_incluexclu_econt(codigo,codigo_excepcion,codigo_servicio,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_ser_incluexclu_econt'),?,?,?,?,?,?,?,?)";
