 ...
 *
 */
public class PostgresqlSubirPacienteDao implements SubirPacienteDao
{
	/**
			...
			String municipio,String localidad,String barrio)
	{
		return SqlBaseSubirPacienteDao.insertarUsuarioCapitado(con, numeroIdentificacion, tipoIdentificacion, fechaNacimiento, sexo, primerNombre, segundoNombre, primerApellido, segundoApellido, direccion, telefono, email,numeroFicha,
				tipoIdEmpleador,numIdEmpleador,razonSociEmpleador,tipoIdCotizante,numIdCotizante,nombresCotizante,apellidosCotizante,parentesco,centroAtencion,tipoAfiliado,excepcionMonto,pais,departamento,
