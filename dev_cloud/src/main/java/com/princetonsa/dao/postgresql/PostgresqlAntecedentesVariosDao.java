/*
 * @(#)PostgresqlAntecedentesVariosDao.java
 *
...
/**
 * Clase que implementa toda la funcionalidad de los antecedentes varios con respecto a la Base de Datos Postgresql
 *
 * @version 1.0, Apr 15, 2003
 * @author <a href="mailto:diego@PrincetonSA.com">Diego Andr&eacute;s Ram&iacute;rez Arag&oacute;n</a>
 */
public class PostgresqlAntecedentesVariosDao implements AntecedentesVariosDao {

	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar un antecedente vario
	 */
	private static final String insertarAntecedenteVarioStr="insert into antecedentes_varios (codigo,fecha, hora,tipo, descripcion,  login_usuario,codigo_paciente) values (nextval('seq_antecedentes_varios'), current_date, current_time,?, ?,?,?)";
	
	/** 
	 * Implementaci&oacute;n de insertar un Antecedente Vario para una Base de datos POSTGRESQL
	...
	/**
	* Implementaci&oacute;n de modificar un Antecedente Vario para una Base de datos POSTGRESQL	 
	* @see com.princetonsa.dao.AntecedentesVariosDao#modificar(java.sql.Connection, int, java.lang.String, java.lang.String, java.lang.String)
	...
	/**
	 * Implementaci&oacute;n de cargar un Antecedente Vario para una Base de datos POSTGRESQL
