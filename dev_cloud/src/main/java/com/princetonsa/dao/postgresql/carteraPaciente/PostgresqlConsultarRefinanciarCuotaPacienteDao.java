...
public class PostgresqlConsultarRefinanciarCuotaPacienteDao implements
	...
	@Override
	public ArrayList<DtoHistoDatosFinanciacion> consultarHistoricoRefinanciacion(
			String codDatosFinanciacion) {
