 ...
 * 
 * Clase dao para la ejecucion de acciones de la funcionalidad de busquedad generica terceros sobre una base de datos postgres 
 *
 */

public class PostgresqlBusquedaTercerosGenericaDao implements
