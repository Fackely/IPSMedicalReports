 ...
 */
public class PostgresqlCIEDao implements CIEDao
{
	/**
	 *  Insertar una vigencia de diagnósticos
	 */
	private final static String insertarCIEStr = "INSERT INTO tipos_cie ( codigo, codigo_real, vigencia ) VALUES (nextval('seq_tipos_cie'),?,?)";
