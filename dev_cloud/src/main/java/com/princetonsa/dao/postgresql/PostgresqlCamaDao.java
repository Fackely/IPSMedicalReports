 ...
 * una base de datos PostgreSQL requeridos por la clase <code>Cama</code>.
 * 
 * @version 1.0, Oct 30, 2002
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>, <a href="mailto:Camilo@PrincetonSA.com">Camilo Andr&eacute;s Camacho P.</a>
 */

public class PostgresqlCamaDao implements CamaDao{

	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar una cama en la base de datos PostgreSQL.
	 */
	private static final String insertarCamaStr="INSERT INTO camas VALUES (nextval('seq_camas'), ?, ?, ?, ?)";


	/**
	 * Inserta una cama en una base de datos PostgreSQL, reutilizando una conexion existente.
	...
	/**
	 * Modifica una cama en una base de datos PostgreSQL, reutilizando una conexion existente.
	 * @param con una conexion abierta con una base de datos PostgreSQL
