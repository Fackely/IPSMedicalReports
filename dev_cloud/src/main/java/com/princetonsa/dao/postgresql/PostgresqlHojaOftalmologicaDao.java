 ...
 */
public class PostgresqlHojaOftalmologicaDao implements HojaOftalmologicaDao
{
	/**
	...
	{
		return SqlBaseHojaOftalmologicaDao.insertarEstrabismo(con, codEncabezadoHisto, ppm, coverTestCercaSc,coverTestCercaCc,coverTestLejosSc, coverTestLejosCc,ojoFijador, ppcInstitucion, prismaCcLejos, prismaScLejos, 
																												duccionesVersiones, testVisionBinocular, estereopsis, amplitudFusionCercaMas, amplitudFusionCercaMenos, amplitudFusionLejosMas, 
																												amplitudFusionLejosMenos, prismaCompensadorLejos, prismaCompensadorCerca);
	}
