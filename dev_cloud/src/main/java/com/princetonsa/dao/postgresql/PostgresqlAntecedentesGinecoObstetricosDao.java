/*
 * @(#)PostgresqlAntecedentesGinecoObstetricosDao.java
 *
 ...
 * a una base de datos PostgreSQL requeridos por la clase <code>AntecedenteGinecoObstetrico</code>.
 * 
...
public class PostgresqlAntecedentesGinecoObstetricosDao implements AntecedentesGinecoObstetricosDao
{
	...
	{
		String secuenciaMetodosAnticonceptivos="nextval('seq_met_anticon_ant_go')";
	...
	/**
	 * Implementación de la inserción de un Antecedente GinecoObstetrico para
	 * una BD Postgresql (Definiendo Transaccionalidad)
	 * 
	 ...
	 * ginecoobstetrico para una BD Postgresql
	 * 
