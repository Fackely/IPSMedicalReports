/*
 * @(#)PostgresqlUsuarioBasicoDao.java
 *
 ...
 * de acceso a una base de datos PostgreSQL requeridos por la clase <code>UsuarioBasico</code>
 *
 * @version 1.0, Oct 1, 2002
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>, <a href="mailto:Camilo@PrincetonSA.com">Camilo Andr&eacute;s Camacho P.</a>
 */

public class PostgresqlUsuarioBasicoDao implements UsuarioBasicoDao 
{
	/**
	...
	*/
	...
	/**
	 * Recupera, desde una base de datos PostgreSQL, los datos basicos de un usuario.
	...
	/**
	 * Implementación en Postgresql de la cargada de Número de Registro Médico
	 ...
	 * y solo tiene el rol paciente en una BD Postgresql
	 *
