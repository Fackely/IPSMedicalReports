...
public class PostgresqlConsultaEnvioInconsistenciasenBDDao implements
	...
	public static String ingresarEnvioInformeIncosist="INSERT INTO envio_info_inconsistencias " +
						 ...
						 "medio_envio," + // 7
						 "path_archivo ) " + // 8
						 "VALUES (nextval('seq_envio_info_inconsistencias'), ?, CURRENT_DATE, "+ValoresPorDefecto.getSentenciaHoraActualBD()+", ?, ?, ?, ?)"; 
	...
	private static String consultaConveniosSrt="SELECT " +
						  ...
						  "FROM convenios " +
						  "WHERE "+ 
						  "activo = true AND reporte_incon_bd='"+ConstantesBD.acronimoSi+"' "; 
