 ...
 * DAO para la funcionalidad de asocios X Tipo de Servicio 
 */
...
public class PostgresqlAsociosXTipoServicioDao implements AsociosXTipoServicioDao {
	...
	public boolean insertarTiposAsocios(Connection con,			
			...
			String usuario)
	{
		String secuencia = "nextval('seq_servicios_asociados')";
