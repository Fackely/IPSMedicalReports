/*
 * @(#)PostgresqlAdmisionHospitalariaDao.java
 *
 ...
 * a una base de datos PostgreSQL requeridos por la clase
 ...
 * P.</a>,
 */
public class PostgresqlAdmisionHospitalariaDao implements AdmisionHospitalariaDao
{
	
	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar una
	 * Admision Hospitalaria usando una BD PostgreSQL.
	 */
	// "numero_autorizacion , " +
	private static final String insertarAdmisionHospitalaria="insert into admisiones_hospi (" +
			...
			"causa_externa , " +			
			"login_usuario , " +
			"cuenta) values (nextval('seq_admisiones_hospi'), ?, ?, ?, ?, CURRENT_DATE, CURRENT_TIME, ?, ?, 1, ?, ?, ?, ?, ?)";


	/**
	 * Cadena constante con el <i>statement</i> necesario para buscar el código
	 * de una Admision Hospitalaria recien insertada usando una BD PostgreSQL. 
	 */
	private static final String buscarCodigoAdmisionRecienInsertada="select last_value as codigoAdmision from seq_admisiones_hospi";
	...
	private static final String insertarTrasladoCamaStr = "INSERT INTO his_cama_pac "
																							...
																							+ "VALUES( nextval('seq_his_cama_pac'), ?, ?, ?, ?, ?, ? )";
	/**
	...
	"SELECT codigo as idAdmision, fecha_admision || '' as fechaAdmision, substring(hora_admision || '' ,0,6) as horaAdmision, origen_admision_hospitalaria as origenAdmision " +
	 ...
	 * postgresql, permitiendo al usuario definir la transaccionalidad
	 * 
	...
	{
	    return SqlBaseAdmisionHospitalariaDao.insertarTransaccional(con, origen, codigoMedico, codigoCama, codigoDiagnostico, 
	    		codigoCIEDiagnostico, codigoCausaExterna, /*numeroAutorizacion, */loginUsuario, cuenta, hora, fecha,
	    		insertarAdmisionHospitalaria, buscarCodigoAdmisionRecienInsertada,estado, institucion) ;
	}
	 ...
	 * estado desinfección en una BD postgresql
	 * 
	 ...
	 * Admision Hospitalaria en una BD postgresql
	 * 
