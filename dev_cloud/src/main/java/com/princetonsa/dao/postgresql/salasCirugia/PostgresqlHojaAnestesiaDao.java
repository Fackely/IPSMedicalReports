...
public class PostgresqlHojaAnestesiaDao implements HojaAnestesiaDao
{
	...
	private static String strInsertarHojaAnestesia = "INSERT INTO " +
			...
			"VALUES(NEXTVAL('seq_cirujanos_esp_int'),?,?,?,?,?,?,?)";
	
	
	private static String strInsertarObservacionesGenerales = "INSERT INTO " +
			"observaciones_hoja_anes(codigo,numero_solicitud,descripcion,fecha,hora,usuario) VALUES(NEXTVAL('seq_observa_hoja_anes'),?,?,?,?,?)";
	...
	"VALUES(NEXTVAL('seq_admin_hoja_anes'),?,?,?,?,?,?)";
	...
	private static String strInsertarInfusionesHojaAnestesia = "INSERT INTO infusiones_hoja_anes (codigo,numero_solicitud,mezcla_inst_cc,otra_infusion,graficar,suspendido,usuario_modifica,fecha_modifica,hora_modifica) " +
	"VALUES(NEXTVAL('seq_infusiones_hoja_anes'),?,?,?,?,?,?,?,?)";
	
	private static String strInsertarAdmInfusionesHojaAnestesia = "INSERT INTO adm_infusiones_hoja_anes (codigo,cod_info_hoja_anes,fecha,hora,usuario_modifica,fecha_modifica,hora_modifica) " +
	"VALUES(NEXTVAL('seq_adm_infusiones_hoja_anes'),?,?,?,?,?,?)";
	
	private static String strInsertarDetInfusionesHojaAnestesia = "INSERT INTO det_infusion_hoja_anes (codigo,cod_adm_info_hoja_anes,articulo,dosis,genero_consumo,usuario_modifica,fecha_modifica,hora_modifica) " +
	"VALUES(NEXTVAL('seq_det_infu_hoja_anes'),?,?,?,?,?,?,?)" ;
	 ...
	 * */
	public HashMap consultarCirujanosSolicitud(Connection con,
			String solicitud) {
