/*
 * @(#)PostgresqlTrasladoCamasDao.java
 *
 ...
 */
public class PostgresqlTrasladoCamasDao implements TrasladoCamasDao 
{
	
	/**
	 * Manejador de logs de la clase
	 */
	private static Logger logger=Logger.getLogger(PostgresqlTrasladoCamasDao.class);
	
	/**
	 * Statement para insertar el log correspondiete al traslado de cama de un paciente cargado en session
	 */
	private final static String insertarlogTrasladoCamaStr="INSERT INTO traslado_cama(codigo," +
			"                       fecha_asignacion," +
			"                       hora_asignacion," +
			"                       codigo_nueva_cama," +
			"                       codigo_cama_antigua," +
			...
			"                       convenio," +
			"                       observaciones)" +
			"                       VALUES(NEXTVAL('seq_traslado_cama'),?,?,?,?,?,CURRENT_DATE,CURRENT_TIME,?,?,?,?,?)";
	...
	public int insertarTrasladoCamaPaciente(Connection con, String fecha_asignacion, String hora_asignacion, int codigoNuevaCama,  int codigoCamaAntigua, int institucion, String usuario, int codigoPaciente, int cuenta, int convenio, String observaciones) throws SQLException
	{
		...
		{
			logger.warn(e+" Error en la insercion de la nueva cama del paciente : PostgresqlTrasladoCamasDao"+e.toString());
			return -1;
		}
	}
