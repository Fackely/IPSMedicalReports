 ...
 * PostgresqlDescuentosComercialesDao
 ...
 * May 22, 2007
 */
public class PostgresqlDescuentosComercialesDao implements DescuentosComercialesDao
{
	...
	{
		String cadena="INSERT INTO desc_com_convcont (codigo,codigo_contrato,institucion,via_ingreso,usuario_modifica,fecha_modifica,hora_modifica,tipo_paciente,fecha_vigencia) values(nextval('seq_desc_com_convcont'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agrup_art_desc_com_convcont(codigo,codigo_descuento,clase,grupo,subgrupo,naturaleza,institucion,porcentaje,valor,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values(nextval('seq_desc_com_convcont'),?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO art_desc_com_convxcont (codigo,codigo_descuento,codigo_articulo,porcentaje,valor,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_art_desc_com_convxcont'),?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agru_ser_desc_com_convxcont(codigo,codigo_descuento,pos,grupo_servicio,tipo_servicio,especialidad,porcentaje,valor,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_agru_desc_com_convxcont'),?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO serv_desc_com_convxcont(codigo,codigo_descuento,codigo_servicio,porcentaje,valor,usuario_modifica,fecha_modifica,hora_modifica,fecha_vigencia) values (nextval('seq_serv_desc_com_convxcont'),?,?,?,?,?,?,?,?)";
