 ...
 */
public class PostgresqlSalarioMinimoDao implements SalarioMinimoDao
{

	/**
	 * Ingresar un salario
	 */
	private static String ingresarSalarioStr="INSERT INTO salario_minimo(codigo,fecha_inicial,fecha_final,salario) values(nextval('seq_salario_minimo'),?,?,?)";
