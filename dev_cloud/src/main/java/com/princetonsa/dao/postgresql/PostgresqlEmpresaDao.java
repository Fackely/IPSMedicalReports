 ...
 */
public class PostgresqlEmpresaDao implements EmpresaDao
{
													...
													int formaPago) throws SQLException
	{
		...
		{
			filtroContactos+=" (SELECT ce.nombre from facturacion.contactos_empresa ce where ce.empresa=e.codigo AND UPPER(ce.nombre) LIKE UPPER('%"+nombreContacto+"%') limit 1 ) ";
		}
		else
		{
