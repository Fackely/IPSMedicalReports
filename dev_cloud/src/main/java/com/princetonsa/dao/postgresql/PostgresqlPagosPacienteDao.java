 ...
 *
 */
public class PostgresqlPagosPacienteDao implements PagosPacienteDao
{
	/**
	 * Secuencia para ingresar un pago de un paciente
	 */
	private String secuenciaStr="SELECT nextval('seq_pagos_paciente')";
	
	/**
	 * Secuencia para ingresar un pago temporal de un paciente
	 */
	private String secuenciaTempoStr="SELECT nextval('seq_pagos_paciente_tempo')";
