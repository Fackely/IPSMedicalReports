/*
* @(#)PostgresqlSolicitudProcedimientoDao.java
*
...
* los servicios de acceso a una base de datos PostgreSQL requeridos por la clase
* <code>SolicitudProcedimiento</code>
*
* @version 1.0, Mar 10, 2004
* @author <a href="mailto:edgar@PrincetonSA.com">Edgar Prieto</a>
*/
public class PostgresqlSolicitudProcedimientoDao implements SolicitudProcedimientoDao
{
	...
	private static final String is_cargar =
		"SELECT "	+	"sp.codigo_servicio_solicitado "	+ "AS codigoServicioSolicitado,"		+								
						...
						"CASE WHEN s.espos THEN 'SI' ELSE '' END AS espos," +
	...
	*/
	...
	{
		String consulta="select coalesce(getTienePortatilSolicitud(?), "+ConstantesBD.codigoNuncaValido+" )";
