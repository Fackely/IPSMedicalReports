 ...
 */
public class PostgresqlCierreSaldoInicialCarteraDao implements
        CierreSaldoInicialCarteraDao  
{
	...
	public boolean cerrarFacturas (Connection con,int codFact)
	{
	     ...
	     */
	    final String cerrarFacturaStr="UPDATE facturas SET factura_cerrada = 'true' WHERE codigo = ?";
