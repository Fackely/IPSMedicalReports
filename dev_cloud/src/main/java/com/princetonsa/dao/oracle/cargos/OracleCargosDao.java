 ...
 *
 */
public class OracleCargosDao implements CargosDao 
{
	/**
	...
	{
		return SqlBaseCargosDao.obtenerNumeroResponsablesSolicitudCargo(con, numeroSolicitud, codigoServicioArticulo, esServicio, " from dual ");
	}
	...
	{
		return SqlBaseCargosDao.updateCantidadesCargo(con,cantidad,numeroSolicitud,subCuenta, codigoArticuloServicio, esServicio);
	}
	...
	{
		String consulta= "SELECT getTotalAdminResponsable("+codigoArticulo+", "+numeroSolicitud+", "+(long)codigoSubcuenta+", "+ValoresPorDefecto.getValorFalseParaConsultas()+") as cant  from dual ";
	...
	/**
	 * Método obtiene cantidad de Inclusiones de un srvicio por paciente
	 * @param con
	 * @param codigoSubcuenta
	 * @param codigoServicio
	 * @return
