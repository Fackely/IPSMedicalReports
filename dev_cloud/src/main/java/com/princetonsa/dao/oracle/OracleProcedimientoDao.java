...
/**
 * Clase para el acceso a la fuente de datos Oracle de un procedimiento
 *
...
public class OracleProcedimientoDao implements ProcedimientoDao
{
	
	/**
	 * Implementación del método utilizado para insertar un nuevo 
	 * procedimiento en una BD Oracle
	 * 
	 ...
	 * nuevo procedimiento en una BD Oracle
	 * 
	 ...
	 * un procedimiento en una BD Oracle
	 * 
	 ...
	 * cuando se selecciona otros procedimientos en una BD Oracle
	 * 
