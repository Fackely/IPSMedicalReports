...
public class OracleHojaQuirurgicaDao implements HojaQuirurgicaDao 
{

	private static final String strEssolicitudTotalFinalizada = "SELECT essolicitudtotalpendiente(?) FROM dual "; 
