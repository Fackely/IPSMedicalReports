 ...
 *
 */
public class OracleTiposMonedaDao implements TiposMonedaDao {
	...
	{
		return SqlBaseTiposMonedaDao.insertarTiposMoneda(con, vo, DaoFactory.ORACLE);
	}
	...
	{
		return SqlBaseTiposMonedaDao.modificarTiposMoneda(con, vo, DaoFactory.ORACLE);
	}
