 ...
 */ 
public class OracleCuentasCobroDao implements CuentasCobroDao, Serializable
{
	 ...
	 * @return
	 */
	public Collection cargarDatosFactura(Connection con,int consecutivoFactura){
		return SqlBaseCuentasCobroDao.cargarDatosFactura(con,consecutivoFactura);
	}
	...
	/**
	 * Implementacion del m�todo que carga todas las solicitudes
	 * para una cuenta con los datos especificos para la impresion
	 * en una BD Oracle
	 */
	public Collection cargarDatosImpresionResumida(Connection con, double numCuentaCobro) throws SQLException
	{
		return SqlBaseCuentasCobroDao.cargarDatosImpresionResumida(con, numCuentaCobro);
	}
	...
	{
		String consulta="select seq_cuentas_cobro.nextval from dual";
	...
	/**
	 * M�todo para cargar la anulacion de una cuenta de cobro con la hora, fehca, usuario, 
