 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OracleRipsDao implements RipsDao {

	/**
	 * Manejador de logs de la clase
	 */
	private static Logger logger=Logger.getLogger(OracleRipsDao.class);
	...
	private final String insertarDatorRipsCitaStr="INSERT INTO rips_consultorios "+
		...
		"VALUES (seq_rips_consultorios.nextval,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	private final String actualizarDatosRipsStr="UPDATE rips_consultorios SET "+ 
		"numero_factura=?, numero_remision=seq_numero_remision.currval, rips=1, fecha_factura=?, " +
	...
	{
		return SqlBaseRipsDao.consultaRegistrosPorRangos(con,codigoConvenio,fechaInicial,fechaFinal,"1");
	}
	...
	
	{
		...
		{
			logger.error("Error en insertarDatosRipsCita de OracleRipsDao: "+e);
			return -1;
		}
	}
			...
			int paciente,int cuenta,int numeroSolicitud,int institucion,String fechaAtencion)
	{
		...
		{
			logger.error("Error en insertarDatosRipsSinServicio de OracleRipsDao: "+e);
			return -1;
		}
	}
	...
	public int actualizarDatosRips(Connection con,int consecutivo, String numeroFactura,String fechaFactura,String fechaRemision,String fechaAtencion,String login)
	{
		...
		{
			logger.error("Error en actualizarDatosRips de OracleRipsDao: "+e);
			return -1;
		}
	}
	...
	{
		String consulta="select seq_numero_remision.nextval AS secuencia";
		try
		{
	...
	{
		return SqlBaseRipsDao.consultaRegistrosRangosPaciente(con,idCuenta,"1");
	}
