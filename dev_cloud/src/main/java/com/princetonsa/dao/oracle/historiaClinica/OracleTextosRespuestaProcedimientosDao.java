...
public class OracleTextosRespuestaProcedimientosDao implements TextosRespuestaProcedimientosDao
{
	/**
	 * Metodo encargado de consultar la informacion de
	 * conceptos especificos glosas, en la tabla "textos_resp_proc".
	 * @author Ing. Felipe Perez Granda
	 * @param connection
	 * @param criterios
	 * ---------------------------------
