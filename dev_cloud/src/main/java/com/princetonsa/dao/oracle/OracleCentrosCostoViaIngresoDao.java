 ...
 */
public class OracleCentrosCostoViaIngresoDao implements CentrosCostoViaIngresoDao 
{
	...
	private final static String insertarCentroCostoViaIngresoStr = " INSERT INTO centro_costo_via_ingreso " +
																  ...
																  " tipo_paciente, " +
																  " institucion ) " +
																  " VALUES (seq_centro_costo_via_ingreso.nextval, ?, ?, ?, ?)" ;
	 ...
	 * @throws SQLException
	 */
	public int modificarCentroCostoViaIngreso(Connection con, int codigoCentroCosto, int codigoViaIngreso, int codigo, int institucion,String codigoTipoPaciente) throws SQLException
	{
		return SqlBaseCentrosCostoViaIngresoDao.modificarCentroCostoViaIngreso(con, codigoCentroCosto, codigoViaIngreso, codigo, institucion, codigoTipoPaciente);
	}
	 ...
	 * @throws SQLException
	 */
	public int insertarCentrosCostoViaIngreso(Connection con, int codigo, int codigoCentroCosto, int codigoViaIngreso, int institucion, String codigoTipoPaciente) throws SQLException
	{
		return SqlBaseCentrosCostoViaIngresoDao.insertarCentrosCostoViaIngreso(con, codigo, codigoCentroCosto, codigoViaIngreso, institucion, insertarCentroCostoViaIngresoStr, codigoTipoPaciente);
	}
}