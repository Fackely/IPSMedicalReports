...
public class OracleMultasDao implements MultasDao {
	...
	public ArrayList<DtoCitasNoRealizadas> buscarCitasNoRealizadasRango(
		...
		return SqlBaseMultasDao.buscarCitasNoRealizadasRango(
				connection, criterios, usuario);
	}
	...
	public ArrayList<DtoServiciosCitas> buscarDetalleCitasRango(Connection connection,
		...
		return SqlBaseMultasDao.buscarDetalleCitasRango(
				connection, usuario, dtoCitasNoRealizadas);
	}
