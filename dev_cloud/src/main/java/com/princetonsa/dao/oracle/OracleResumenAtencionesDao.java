/*
 * @(#)OracleResumenAtencionesDao.java
 *
 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>ResumenAtenciones</code>
 * 
 *	@version 1.0, 15/06/2004
 */
public class OracleResumenAtencionesDao implements ResumenAtencionesDao
{
	/**
	 * Implementación de la revisión de los antecedentes que existen
	 * para paciente dado en una BD Oracle
	 * 
	 ...
	 * paciente dado en una BD Oracle
	 * 
	 ...
	 * de urgencias para una cuenta dada en una BD Oracle
	 * 
	...
	/**
	 * Implementación de la búsqueda de los datos de la admisión
	 * de hospitalización para una cuenta dada en una BD Oracle
	 * 
	 ...
	 * para una cuenta dada en una BD Oracle
	 * 
	 ...
	 * una cuenta dada en una BD Hsqldb Oracle
	 * 
	 ...
	 * valoración para una cuenta dada en una BD Oracle
	 * 
	...
	/**
	 * @see com.princetonsa.dao.ResumenAtencionesDao#existeNotasGenerales(java.sql.Connection, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
