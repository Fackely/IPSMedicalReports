...
public class OracleInformacionPartoDao implements InformacionPartoDao 
{
	/**
	...
	{
		return SqlBaseInformacionPartoDao.insertarInformacionParto(con,infoParto,"seq_informacion_parto.nextval","seq_info_parto_secciones.nextval","seq_info_aborto_hijos.nextval",estado);
	}
	...
	{
		return SqlBaseInformacionPartoDao.insertarVigilenciaClinica(con, consecutivoInfoParto, vigilanciaClinicaMap, "seq_vig_cli_trab_parto.nextval", usuario);
	}
	...
	{
		return SqlBaseInformacionPartoDao.obtenerControlPrenatal(con, codigoCx, codigoInstitucion, "FROM dual");
	}
