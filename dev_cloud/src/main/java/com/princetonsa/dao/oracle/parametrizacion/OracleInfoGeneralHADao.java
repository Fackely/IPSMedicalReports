 ...
 *
 */
public class OracleInfoGeneralHADao implements InfoGeneralHADao 
{
	/**
	 * 
	 * @param con
	...
	{
		return SqlBaseInfoGeneralHADao.obtenerUltimaFechaHoraGraficarRecord(con, numeroSolicitud,DaoFactory.ORACLE);
	}
}
