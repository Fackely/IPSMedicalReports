...
public class OracleRegistroAccidentesTransitoDao implements
		RegistroAccidentesTransitoDao
{
	...
	public DtoRegistroAccidentesTransito consultarRegistrosAccidentesTransito(
			Connection con, String ingres)
	{
		return SqlBaseRegistroAccidentesTransitoDao.consultarRegistrosAccidentesTransito(con, ingres);
	}
