 ...
 * de datos en la funcionalidad Lectura Planos Pacientes Entidades Subcontratadas
 */
public class OracleLecturaPlanosEntidadesDao implements LecturaPlanosEntidadesDao 
{
	/**
	...
	/**
	 * Método que actualiza el campo inconsistencia en una factura de la tabla AF
	 * @param con
	 * @param numeroFactura
	 * @return
	 */
