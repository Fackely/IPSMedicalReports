/*
 * @(#)OracleEvolucionHospitalariaDao.java
 *
 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>EvolucionHospitalaria</code>
 *
 * @version May 29, 2003
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>
 */

public class OracleEvolucionHospitalariaDao extends OracleEvolucionDao implements EvolucionHospitalariaDao 
{

	/**
	 * Implementación del método que inserta una evolución hospitalaria, 
	 * soportando la definición de transaccionalidad en una BD Oracle
	 * 
