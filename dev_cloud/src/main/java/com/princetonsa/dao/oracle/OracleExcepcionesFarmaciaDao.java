/*
 * @(#)OracleExcepcionesFarmaciaDao.java
 *
 ...
 */
public class OracleExcepcionesFarmaciaDao implements ExcepcionesFarmaciaDao
{//SIN PROBAR FUNC. SECUENCIA
	 ...
	 */
    private final static String insertarBaseExcepcionFarmaciaStr="INSERT INTO excepciones_farmacia (codigo, convenio, centro_costo, articulo, no_cubre) values (seq_excepciones_farmacia.nextval, ?, ? , ?, ?)";
    
	/**
	 * Implementación del método que inserta
	 * una excepción de farmacia en una BD Oracle
	 * 
	 ...
	 * las excepciones de farmacia en una BD Oracle
	 * 
    ...
    public ResultSetDecorator consultarBaseExcepcionFarmacia (Connection con, int codigoConvenioBusqueda, int codigoCentroCostoBusqueda, int codigoArticuloBusqueda, String nombreArticuloBusqueda) throws SQLException
    {
        ...
        //(Oracle), para dejar el método en el base
        ...
        {
            restriccionPorNombreArticulo=" and UPPER(art.descripcion) LIKE UPPER('" + nombreArticuloBusqueda + "')";
        }
	 ...
	 * de un registro previo en una BD Oracle
	 * 
