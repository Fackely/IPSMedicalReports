 ...
 */
public class OracleRegistroEnfermeriaDao implements RegistroEnfermeriaDao
{
	...
	{
		String secuencia="seq_registro_enfermeria.nextval as codigo";
	...
	{
		String secuencia="seq_enca_histo_registro_enfer.nextval as codigo";
    ...
    {
		String secuencia="  seq_fin_turno_balance_liq.nextval as codigo ";
    ...
    {
		String secuencia=" seq_medicamento_infusion_enfer.nextval as codigo ";
...
//		**************************METODOS DE LA SECCION DE CONTROL DE ESFINTERES *************************
	 ...
	 */
	@Override
	public ArrayList<String> insertarRegistroAlertaOrdenesMedicas(
			Connection con,
