...
/**
 * Implementación en Oracle de la <i>interface</i>
...
public class OraclePersonaBasicaDao implements PersonaBasicaDao, Serializable
{
	 ...
	 */
	private static final String cargarPacienteConsultaResponsableStr="select getnomdeudoringreso(?) FROM DUAL";
	...
	*/
	...
	public void cargarEmpresaRazon(Connection con, int cod, String codRegimen, PersonaBasica personaBasica) throws SQLException {
		String cargarNombresRazonsocialEmpresaPacientestr="SELECT getEmpresaResponsable(?) as empresa,getNomRegimen(?) as regimen from dual";
	...
	{
	    return SqlBasePersonaBasicaDao.getFechaHoraApertura (con, idCuenta,DaoFactory.ORACLE) ;
	}
