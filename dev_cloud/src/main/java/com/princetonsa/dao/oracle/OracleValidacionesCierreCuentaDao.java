 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OracleValidacionesCierreCuentaDao implements ValidacionesCierreCuentaDao{
	/**
	 * Manejador de logs de la clase
	 */
	private Logger logger=Logger.getLogger(OracleValidacionesCierreCuentaDao.class);
