/*
 * @(#)OracleParametrizacionCurvaAlertaDao
 *
 ...
 */
public class OracleParametrizacionCurvaAlertaDao implements ParametrizacionCurvaAlertaDao
{
	/**
	 * INSERTAR
	 */
	private static String insertarStr= "INSERT INTO param_curva_alert_partograma (codigo,posicion,paridad,membrana,rango_inicial,rango_final,valor,activo,institucion) VALUES (seq_param_alert_partograma.nextval, ?, ?, ?, ?, ?, ?, ?, ?) ";
