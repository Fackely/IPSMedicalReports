 ...
 *
 */
public class OracleConsecutivosCentroAtencionDao implements ConsecutivosCentroAtencionDao{
	...
	public BigDecimal incrementarConsecutivo(int centroAtencion, String nombreConsecutivo,
			int institucion) {
		String consulta="select administracion.siguienteConsdisponibleCentro('"+nombreConsecutivo+"',"+institucion+",'"+UtilidadFecha.getMesAnioDiaActual("anio")+"', "+centroAtencion+") as valor from dual";
