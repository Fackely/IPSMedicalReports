...
public class OracleAperturaIngresosDao implements AperturaIngresosDao
{
	...
	private static final String strConsultaIngresosXPaciente = " SELECT " +
		...
		" AND (select cuentas.estado_cuenta from cuentas where id_ingreso=ing.id "+ValoresPorDefecto.getValorLimit1()+" 1 and getcuentafinalasocio(id_ingreso,id) is null ) in(0,3,6) " +
