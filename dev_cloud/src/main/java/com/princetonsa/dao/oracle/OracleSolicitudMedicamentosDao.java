 ...
 * Princeton S.A.
 */
public class OracleSolicitudMedicamentosDao implements SolicitudMedicamentosDao
{
	/**
	...
	*/
	...
	{
		return SqlBaseSolicitudMedicamentosDao.consultarSolicitudesMedicamentoConAdministracion(con,cuenta,DaoFactory.ORACLE);
	}
	/**
	...
	{
		return SqlBaseSolicitudMedicamentosDao.consultarSolicitudesMedicamento(con, criteriosBusquedaMap,DaoFactory.ORACLE);
	}
