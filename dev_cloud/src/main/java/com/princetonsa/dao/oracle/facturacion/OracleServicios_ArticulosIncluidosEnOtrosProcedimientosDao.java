...
public class OracleServicios_ArticulosIncluidosEnOtrosProcedimientosDao	implements Servicios_ArticulosIncluidosEnOtrosProcedimientosDao {
	...
	{
		String consulta="SELECT getSolicitudTieneIncluidos(?) from dual ";
