...
public class OracleTiposInventarioDao implements TiposInventarioDao  
{
	...
	public  boolean insertarSubGruposInventario(Connection con, HashMap vo)
	{
		...
		//return SqlBaseTiposInventarioDao.insertarClaseInventario(con, vo, cadena);
		String cadena="INSERT INTO inventarios.subgrupo_inventario (codigo,subgrupo,grupo,clase,nombre,institucion,cuenta_inventario,cuenta_costo,rubro_presupuestal) values (SEQ_SUBGRUPO_INVENTARIO.nextval,?,?,?,?,?,?,?,?)";
