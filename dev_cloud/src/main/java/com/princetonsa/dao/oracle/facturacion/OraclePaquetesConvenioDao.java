...
public class OraclePaquetesConvenioDao implements PaquetesConvenioDao 
{
	...
	{
		String cadenaInsertarStr="INSERT INTO paquetes_convenio (codigo,institucion,convenio,contrato, paquete, via_ingreso, tipo_paciente, fecha_inicial_venc, fecha_final_venc, usuario_modifica, fecha_modifica, hora_modifica) VALUES (seq_paq_convenios.NEXTVAL,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
