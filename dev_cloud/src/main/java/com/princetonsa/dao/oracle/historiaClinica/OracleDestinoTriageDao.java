 ...
 * de datos en la funcionalidad Parametrización de Destinos Triage
 */
public class OracleDestinoTriageDao implements DestinoTriageDao 
{
	/**
	...
	{
		return SqlBaseDestinoTriageDao.insertar(con,codigo,nombre,indicadorAdmiUrg,institucion,"seq_destino_paciente.nextval");
	}
