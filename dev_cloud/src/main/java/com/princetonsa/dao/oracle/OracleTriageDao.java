...
import com.princetonsa.dao.postgresql.PostgresqlTriageDao;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class OracleTriageDao implements TriageDao {
	/**
	 ...
	 */
	private String insertarTriageinicioStr="insert into triage(consecutivo,consecutivo_fecha,fecha,hora,primer_nombre,segundo_nombre,primer_apellido,segundo_apellido,";
	/* (non-Javadoc)
