 ...
 *
 */
public class OracleEpicrisis1Dao implements Epicrisis1Dao 
{
	private final String consultaEpicrisis=" SELECT " +
												"usuario_modifica as usuariomodifica, " +
												"finalizada as finalizada, " +
												UtilidadBD.convertirDatoClob("contenido_encabezado",Epicrisis1.maximoContenidoCuadroTexto,1)+" as contenidoencabezado, " +
	...
	{
		return SqlBaseEpicrisis1Dao.obtenerFechaHoraSolicitudes(con, cuentas, criteriosBusquedaMap, ingreso, valoracionesInicialesAmostrar, "", "");
	}
