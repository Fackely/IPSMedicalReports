...
public class OracleCargosOdonDao  implements CargosOdonDao
{
	@Override
...
/*	@Override
	...
	@Override
	public boolean liberarSerialBono(Connection con, int convenio, int ingreso, BigDecimal serial, int programa)
	{
