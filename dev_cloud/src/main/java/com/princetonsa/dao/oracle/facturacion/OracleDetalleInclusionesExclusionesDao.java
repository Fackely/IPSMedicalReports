 ...
 * OracleDetalleInclusionesExclusionesDao
 ...
 * May 22, 2007
 */
public class OracleDetalleInclusionesExclusionesDao implements DetalleInclusionesExclusionesDao
{
	...
	{
		String cadena="INSERT INTO inclu_exclu_cc (codigo,codigo_inclu_exclu,institucion,codigo_centro_costo,usuario_modifica,fecha_modifica,hora_modifica) values(seq_inclu_exclu_cc.nextval,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agru_art_incluexclu_cc(codigo,codigo_inclu_exclu_cc,clase,grupo,subgrupo,naturaleza,institucion,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values(seq_agru_art_incluexclu_cc.nextval,?,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO art_incluexclu_cc (codigo,codigo_inclu_exclu_cc,codigo_articulo,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values (seq_art_incluexclu_cc.nextval,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO agru_ser_incluexclu_cc(codigo,codigo_inclu_exclu_cc,pos,grupo_servicio,tipo_servicio,especialidad,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values (seq_agru_ser_incluexclu_cc.nextval,?,?,?,?,?,?,?,?,?,?)";
	...
	{
		String cadena="INSERT INTO ser_incluexclu_cc(codigo,codigo_inclu_exclu_cc,codigo_servicio,incluye,cantidad,usuario_modifica,fecha_modifica,hora_modifica) values (seq_ser_incluexclu_cc.nextval,?,?,?,?,?,?,?)";
