 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>Evolucion</code>
 *
 * @version May 26, 2003
 * @author 	<a href="mailto:Oscar@PrincetonSA.com">&Oacute;scar Andr&eacute;s L&oacute;pez P.</a>
 */

public class OracleEvolucionDao implements EvolucionDao
{//SIN PROBAR FUNC. SECUENCIA

	/**
	 * Nombre de la secuencia que maneja la evolución
	 */
	public static final String nombreSecuencia="seq_evolucion";
