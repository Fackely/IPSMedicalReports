 ...
 * @author wrios
 */
public class OracleContratoDao implements ContratoDao 
{//SIN PROBAR FUNC. SECUENCIA
										...
										)
	{
		return SqlBaseContratoDao.insertar(	 con,  codigoConvenio, numeroContrato, 
																		 ...
																		 sinContrato, frmObservaciones, pacientePagaAtencion, validarAbonoAtencionOdo, manejaTarifasXCA);
	}
	...
	*/
											...
											boolean manejaTarifasXCA)
	{
		return SqlBaseContratoDao.modificar(	 con,  codigo, numeroContrato, 
																			...
																			fechaFirmaContrato, diaLimiteRadicacion,
																			diasRadicacion, controlaAnticipos,
																			manejaCobertura, codigoTipoPago, upc, pyp,
													...
													) throws SQLException
	{
		return SqlBaseContratoDao.busqueda(	con,nombreConvenio,numeroContrato,
																			...
																			fechaInicial,fechaFinal, codigoInstitucion,
																			valorContrato, valorAcumulado, nombreTipoPago, 
																			upc, pyp, contratoSecretaria, busquedaNivelAtencion,
																			porcentajeUpc, base, requiereAutorizacionNoCobertura, sinContrato,esquemaTarInventario,esquemaTarProcedimiento, frmObservaciones, manejaTarifasXCA);												
	}
	...
	{
		return SqlBaseContratoDao.obtenerContratosTopesCompletos(con, contratos, cuenta);
	}
	 ...
	 * 
	 */
	public HashMap obtenerEsquemasTarifariosInventariosVigentes(Connection con,int ingreso, String fecha) 
	{
		String consulta="from (select codigo,contrato,clase_inventario,esquema_tarifario,fecha_vigencia, centro_atencion from esq_tar_inventarios_contrato where fecha_vigencia||''<'"+UtilidadFecha.conversionFormatoFechaABD(fecha)+"') tabla ";
		return SqlBaseContratoDao.obtenerEsquemasTarifariosInventariosVigentes(con,ingreso,consulta);
	}
	 ...
	 * 
	 */
	public HashMap obtenerEsquemasTarifariosProcedimientosVigentes(Connection con,int ingreso, String fecha) 
	{
		String consulta="from (select codigo,contrato,grupo_servicio,esquema_tarifario,fecha_vigencia, centro_atencion from esq_tar_procedimiento_contrato where fecha_vigencia||''<'"+UtilidadFecha.conversionFormatoFechaABD(fecha)+"') tabla";
		return SqlBaseContratoDao.obtenerEsquemasTarifariosProcedimientosVigentes(con,ingreso,consulta);
	}
