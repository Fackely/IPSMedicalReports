 ...
 */
public class OracleTiposMonitoreoDao implements TiposMonitoreoDao {
	/**
	 * Cadena que inserta un nuevo registro de tipo monitoreo
	 */
	private static final String insertarTipoMonitoreoStr="INSERT INTO tipo_monitoreo (codigo, nombre, prioridad_cobro, servicio, institucion, requiere_valoracion) values (seq_tipo_monitoreo.nextval,?,?,?,?,?)";
