 ...
 * de acceso a una base de datos Oracle requeridos por la clase <code>GeneracionExcepcionesFarmacia</code>
 *
 * @version 1.0, 7/12/2004
 * @author <a href="mailto:joan@PrincetonSA.com">Joan L&oacute;pez</a>
 * @author <a href="mailto:wilson@PrincetonSA.com">Wilson Rios</a>
 */
public class OracleGeneracionExcepcionesFarmaciaDao implements
