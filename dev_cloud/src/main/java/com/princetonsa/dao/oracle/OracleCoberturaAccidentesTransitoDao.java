/*
 * OracleCoberturaAccidentesTransitoDao.java 
 * Autor			:  mdiaz
...
/**
 * Implementación del Dao de cobertura de accidentes de transito para Oracle
 *
 * @version 1.0, 25-nov-2004
 * @author <a href="mailto:miguel@PrincetonSA.com">Miguel Arturo Diaz</a>
 */
public class OracleCoberturaAccidentesTransitoDao implements CoberturaAccidentesTransitoDao
{
	/**
