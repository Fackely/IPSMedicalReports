 ...
 * antecedente a medicamento para inicioTransaccion.
 *
 * @version 1.0, Agosto 26, 2003
 * @author <a href="mailto:Liliana@PrincetonSA.com">Liliana Caballero</a>
 */
public class OracleAntecedenteMedicamentoDao implements AntecedenteMedicamentoDao
{
																		...
																		String tipofrecuencia, String unidosis) throws SQLException
	{
	    return SqlBaseAntecedenteMedicamentoDao.insertarTransaccional(	con,
				...
				fechaFin,
				observaciones,
				estado,cantidad,dosisD,tiempoT,
				tipofrecuencia, unidosis);
	}
