...
public  class OracleConsentimientoInformadoDao implements ConsentimientoInformadoDao
{

	 /**
	 * Cadena de insercion Oracle de consentimiento informado
	 */
	
	private static final String cadenaInsertarStr = "INSERT INTO historiaclinica.consentimientoinformado (codigo,institucion,descripcion,nombre_archivo,nombre_original,usuario_modifica,fecha_modifica,hora_modifica) VALUES(historiaclinica.seq_consentimientoinformado.nextval,?,?,?,?,?,?,?) ";
