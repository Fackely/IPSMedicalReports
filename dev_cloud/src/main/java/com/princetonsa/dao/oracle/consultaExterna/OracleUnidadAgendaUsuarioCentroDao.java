...
public class OracleUnidadAgendaUsuarioCentroDao implements UnidadAgendaUsuarioCentroDao
{
	/**
	 * Metodo para Consultar Unidad De Agenda Principal
	 * @param con
	 * @return
	 */
	...
	{
		return SqlBaseUnidadAgendaUsuarioCentroDao.insertarUnidad(con, mundo, DaoFactory.ORACLE);
	}
	...
	{
		return SqlBaseUnidadAgendaUsuarioCentroDao.modificar(con, mundo,DaoFactory.ORACLE);
	}
