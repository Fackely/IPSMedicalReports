/*
 * @(#)OracleEsquemaTarifarioDao.java
 * 
 ...
 */
public class OracleEsquemaTarifarioDao implements EsquemaTarifarioDao
{//SIN PROBAR FUNC. SECUENCIA

	/**
	 * Cadena constante con el <i>statement</i> necesario para insertar 
	 * una nueva entrada en la esquemas_tarifarios para una BD Oracle
	*/
	private static final String insertarEsquemaTarifarioStr="INSERT INTO esquemas_tarifarios (codigo, nombre, tarifario_oficial, metodo_ajuste, es_inventario, institucion, activo, cantidad) VALUES (seq_esquemas_tarifarios.nextval, ?, ?, ?, ?, ?, ?, ?)";
