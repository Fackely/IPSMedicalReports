...
public class ReporteFacturasVencidasNoObjetadasForm extends ValidatorForm
{
	/**
	 * Para hacer logs de esta funcionalidad.
	 */
	private Logger logger = Logger.getLogger(ReporteFacturasVencidasNoObjetadasForm.class);
