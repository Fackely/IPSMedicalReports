...
/**
 * Esta clase es auxiliar de <code>TagAdminMedicamentos</code>
 ...
 * que recorrerlo)
 *
 *	@version 1.0, sept 20, 2004
 */
public class TEIAdminMedicamentos extends TagExtraInfo 
{
	/**
