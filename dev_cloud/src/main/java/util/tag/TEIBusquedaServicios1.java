...
/**
 * Esta clase es auxiliar de <code>TagBusquedaServicios1</code>
 ...
 * que recorrerlo)
 *
 *	@version 1.0, Julio 23, 2004
 */
public class TEIBusquedaServicios1 extends TagExtraInfo 
{
	/**
	 * Define las <i>scripting variables</i> usadas en TagBusquedaServicios1 y las
